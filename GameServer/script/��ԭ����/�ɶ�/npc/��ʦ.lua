...
function CallBackStepInq(szKey, nKey1, nKey2, nCount)
	...
	if tong_state == 1 then
		Say("Quı bang vÉn ch­a nhËn chuçi nhiÖm vô nµy, chuçi nhiÖm vô nµy ®Õn <color=yellow>"..dialog_date_now.."<color>.",
			1,
			"Ta biÕt råi/Zgc_end_dialog"
		)		
	elseif tong_state == 2 then
		Say("Quı bang ®· nhËn nhiÖm vô, t×nh h×nh thu thËp vµ giao nép vËt phÈm lµ:"..tong_num.."/"..Zgc_conf_task_goos_num[tong_level][1]..", chuçi nhiÖm vô nµy ®Õn"..dialog_date_now.."ends",
			1,
			"Ta biÕt råi/Zgc_end_dialog"
		)
