...
if ( UWorld1402 > 20 )  then
		Say("Ta cÇn <color=red>Kú Th¹ch TuyÕt Ph¸ch<color> cña <color=red>B¨ng Qu¸i<color> ë tÇng 2 B¨ng T©m ®éng ®Ó lµm Thiªn Lang Ch©m, nÕu ng­¬i cã thÓ t×m gióp ta <color=red>15 TuyÕt Ph¸ch<color> ®Ó ta lµm ph¸p khÝ, ta sÏ cho ng­¬i 10 viªn kú th¹ch <color=red>U Hån<color>.",
		2,
...
elseif ( UWorld1402  == 15 and  GetItemCount(2,3,12) >  9 ) then
		if  DelItem(2,3,12,10) == 1 then 
				Talk(1,"","Hay l¾m! §a t¹ b»ng h÷u t­¬ng trî! Ta vèn nghÜ chØ cÇn mét m×nh ta còng cã thÓ ®uæi bän yªu ma quû qu¸i nh­ng xem ra kh«ng ®­îc. h·y ®Õn <color=red>Nga My s¬n<color> t×m <color=red>D­¬ng NguyÖt S­ Th¸i<color>, víi ph¸p lùc cña bµ ta kh«ng chõng sÏ cã c¸ch ®èi phã.")
				 ...
				 --AddNote("È¥¶ëÃ¼É½ÇóÖúÓÚÑôÔÂÊ¦Ì«£¬¿´¿´ÓÐÊ²Ã´°ì·¨¡£")
				 TaskTip("§Õn Nga My s¬n nhê D­¬ng NguyÖt S­ Th¸i gióp ®ì.")
		else
				 Talk(1,"","ChuyÓn giao vËt phÈm kh«ng thµnh c«ng")
		end
elseif ( UWorld1402  == 20 ) then
				Talk(1,"","§¸m yªu nghiÖt nµy nhÊt ®Þnh cã chót xuÊt sø, h·y ®Õn <color=red>Nga My s¬n<color> t×m <color=red>D­¬ng NguyÖt S­ Th¸i<color>, víi ph¸p lùc cña bµ ta kh«ng chõng sÏ cã c¸ch ®èi phã.")
else
		Talk(1,"","Ta nhÊt ®Þnh sÏ diÖt trõ bän yªu nghiÖt nµy!")
end
end;
