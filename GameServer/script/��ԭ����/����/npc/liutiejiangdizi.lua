...
Include("\\script\\vng\\weapon_upgrade\\trangbihaohiepvoha.lua");
--201403»î¶¯
...
{{"Thµnh ThÕ kim b¶o r­¬ng",2,0,1028,2},{"Qu Yuan Pendant",0,102,27},{"Tèc ®é thi triÓn vâ c«ng t¨ng 5%",1,477,"Maximum HP 6%",2,253,"600 gi©y ®é bÒn vò khİ håi phôc 5",5,43},"Hiªn Viªn ChiÕn"},
...
{"Th¸i H­",0,9,88},{"Mu Jianlian Staff",0,8,98},{"Medicine Master Staff",0,8,99},{"Cöu Long Toµn Kİch",0,6,109},{"Spear Slave",0,6,110},{"Viªn §Ò",0,4,120},
{"Shoot Without Shooting",0,4,121},{"Boundless Silver",0,11,13},{"Thanh Long",0,11,14},{"Bİch Thñy",0,7,13},{"Thiªn T«n",0,7,14}}; 
...
--		"»Ô»ÍÈÙÒ«Ïà¹ØÄÚÈİ/about_hhry"
	...
	tinsert(strtab,"N©ng cÊp trang bŞ míi/TrangBiHaoHiepVoHa_Form");
...
function how_change_ring(nPage)
	...
	for i = 1,nDiaNum do
		tinsert(strtab,tChangeRing[nPage*nPageNum+i][1][5].."c¸i"..tChangeRing[nPage*nPageNum+i][1][1].." (or 1"..tChangeRing[nPage*nPageNum+i][4]..") +1 "..tChangeRing[nPage*nPageNum+i][2][1].."--> Thuéc tİnh ®Æc biÖt"..tChangeRing[nPage*nPageNum+i][4].."/#change_ring_detail("..(nPage*nPageNum+i)..")");
	end
	if nPage ~= 0 then
...
function change_ring_detail(nIndex)
	Talk(1,"#how_change_ring(0)","…"..tChangeRing[nIndex][1][5].."c¸i"..tChangeRing[nIndex][1][1].." (or 1"..tChangeRing[nIndex][4]..") and 1"..tChangeRing[nIndex][2][1].."§æi 3 thuéc tİnh thµnh: <color=yellow>"..tChangeRing[nIndex][3][1]..","..tChangeRing[nIndex][3][4]..","..tChangeRing[nIndex][3][7].."<color> "..tChangeRing[nIndex][4]);
end
...
function confirm_box_change_ring(nIndex)
	Say("Ng­¬i chän dïng "..tChangeRing[nIndex][1][5].."c¸i"..tChangeRing[nIndex][1][1].." and 1"..tChangeRing[nIndex][2][1].." ®æi 3 thuéc tİnh thµnh <color=yellow>"..tChangeRing[nIndex][3][1]..","..tChangeRing[nIndex][3][4]..","..tChangeRing[nIndex][3][7].."<color> "..tChangeRing[nIndex][4]..". X¸c ®Şnh kh«ng?",
		2,
...
function confirm_ring_change_ring(nIndex)
	Say("Ng­¬i chän dïng 1 "..tChangeRing[nIndex][4].." and 1"..tChangeRing[nIndex][2][1].." ®æi 3 thuéc tİnh thµnh <color=yellow>"..tChangeRing[nIndex][3][1]..","..tChangeRing[nIndex][3][4]..","..tChangeRing[nIndex][3][7].."<color> "..tChangeRing[nIndex][4]..". X¸c ®Şnh kh«ng?",
		2,
...
function confirm_wp_change_ring(nType)
	...
	Say("Ng­¬i x¸c ®Şnh dïng <color=red>"..tChangeWp[nIndex][1].."<color>to change <color=yellow>"..tWpChangeRing[nIndex][nType][1].."<color> ?",
		2,
...
function give_change_ring(nIndex,nType)
	...
	if DelItemByIndex(nIdx,-1) == 1 then
		...
		if Add_flag == 1 then
			...
			WriteLog("§Ö tö thî rÌn L­u-Vò khİ Hoµng ®Õ ®æi trang søc Hoµng ®Õ: Ng­êi ch¬i"..GetName().."Use card"..tChangeWp[nIndex][1].."§æi"..tWpChangeRing[nIndex][nType][1].." thµnh c«ng!");
		else
			WriteLog("§Ö tö thî rÌn L­u-Vò khİ Hoµng ®Õ ®æi trang søc Hoµng ®Õ: Ng­êi ch¬i"..GetName().."Use card"..tChangeWp[nIndex][1].."§æi"..tWpChangeRing[nIndex][nType][1].."thÊt b¹i! log: "..Add_flag);
		end
	end
end	
...
function ask_quchu_lingshi(nWz,nType)
	local tChouqu = {"§Çu","Ngo¹i trang","Vò khİ","Lower Garment"}
...
function add_lingqi_ask(nWz)
	local tWz = {"§Çu","Ngo¹i trang","Vò khİ","Lower Garment"};
...
function ask_is_duihuan(nType,nWp,nLingqi)
	...
	Say("<color=green>§Ö tö thî rÌn L­u<color>: Ng­¬i muèn dïng Thanh §ång ®Ønh cÊp 1 ®æi linh khİ <color=yellow>"..nLingqi.."-"..tTiandiName[nType].."<color> ?",
		3,
...
function ask_yanhuang_duihuan(nType,nWp,nLingqi)
	local tTiandiName = {"Thiªn §Şa HuyÒn Hoµng Kh«i","Thiªn §Şa HuyÒn Hoµng Gi¸p ","GiÇy Thiªn §Şa HuyÒn Hoµng","Vò khİ Thiªn §Şa HuyÒn Hoµng"};
	Say("<color=green>§Ö tö thî rÌn L­u<color>: Ng­¬i muèn dïng Viªm Hoµng ThiÕt Hån ®æi ®iÓm linh khİ <color=yellow>"..nLingqi.."-"..tTiandiName[nType].."<color> ?",
		3,
...
function choose_xuanyuan(nType)
	...
	Say("<color=green>§Ö tö thî rÌn L­u<color>: Dïng 4 R­¬ng vµng ThŞnh ThÕ ®æi 1 <color=yellow>"..tRing[nType].."<color> ?",
		2,
...
function uplevel_hhry(nType)
	Say("<color=green>§Ö tö thî rÌn L­u<color>: Ng­¬i muèn lÊy <color=yellow>"..tHuihuang[nType][1].." and"..tRongyao[nType][1].."<color> th¨ng cÊp thµnh <color=yellow>"..tHuihuang[nType+1][1].." and"..tRongyao[nType+1][1].."<color> kh«ng? CÇn thu thËp <color=yellow>"..tUplevel[nType][1]..tUplevel[nType][5].." <color>. <color=yellow>Chó ı, mang 2 trang søc muèn th¨ng cÊp lªn ng­êi. <color>",
		3,
	...
	if DelItem(tUplevel[nType][2],tUplevel[nType][3],tUplevel[nType][4],tUplevel[nType][5]) == 1 then
		if DelItemByIndex(nIdx1,-1) == 1 and DelItemByIndex(nIdx2,-1) == 1 then
			...
			if nAddFlag == 1 then
				...
				WriteLog("[Huy hoµng vinh dù]: Ng­êi ch¬i "..GetName().." bring"..tHuihuang[nType][1].."T¨ng cÊp thµnh "..tHuihuang[nType+1][1].." thÊt b¹i, kı hiÖu:"..nAddFlag);
			end
			...
			if nAddFlag == 1 then
				...
				WriteLog("[Huy hoµng vinh dù]: Ng­êi ch¬i "..GetName().." bring"..tRongyao[nType][1].."T¨ng cÊp thµnh "..tRongyao[nType+1][1].." thÊt b¹i, kı hiÖu:"..nAddFlag);
			end
		else
