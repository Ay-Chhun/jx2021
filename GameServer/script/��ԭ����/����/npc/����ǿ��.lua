...
function qianghua()
	local tSay = {
		...
		--"ÎïÆ·¶¨»ê£¨+15£©/#qianghua_(-4)",
		--format("%s/#talk_compose_pojingshi('%s')", "ºÏ³ÉÆÆ¾«Ê¯", "ÁõÌú½³"),
		"Rêi khái/zhaohu",
	}
	local szTitle = "C­êng hãa vËt phÈm chia thµnh c­êng hãa vËt phÈm th«ng th­êng, c­êng hãa vËt phÈm cao cÊp vµ ®Şnh hån."
