...
function main()
	...
	local selTab = {
			...
			"Take hoe/get_hoe",
			"trë l¹i"..tCampNameZ[nCamp].."Rear camp/back_to_home",
			"Collecting/nothing"
			}
...
function handin(nType)
	...
	Talk(1,"","<color=green>"..nNpcName.."<color>: Hand in <color=yellow>"..str1..str2..str3.."<color> gióp phe m×nh t¨ng thªm <color=yellow>"..nBattlePoint.."<color> ®iÓm tÝch lòy. Tæng ®iÓm tÝch lòy <color=yellow>"..Get_ResCount(nCamp).."<color>");
	Msg2MSGroup(MISSION_ID,GetName().." Hand in"..str1..str2..str3.."§iÓm tÝch lòy hiÖn t¹i"..Get_ResCount(nCamp),nCamp);
end;
