...
function OnDeath(Launcher)
	...
	Msg2Player("B¹n ®· giÕt"..tCampNameZ[nDeathCamp].."Faction"..sDeathName.." phe Tèng, sè ®Şch giÕt ®­îc: "..BT_GetData(PTNC_KILL)..", giÕt liªn tôc ®­îc:"..BT_GetData(PTNC_SERIES_KILL));
	PlayerIndex = nDeathIndex;
