...
function wb_SmallBoxAward()
	...
	local tAward = {
		...
		{1, 5000, "Liu Jin", {2, 1, 31096, 1, 4}, 0, 0, 0, 1},
		{1, 7000, "Da Di Long", {2, 1, 30672, 50, 1}, 0},
		{1, 7000, "Da Ma Lang", {2, 1, 30673, 50, 1}, 0},
		{1, 7000, "Yan Ling Si", {2, 1, 30671, 50, 1}, 0},
		{1, 7000, "HuyÒn Viªm ThiÕt", {2, 1, 30670, 30, 1}, 0},
		{1, 7000, "Tiªn ¢m Th¹ch", {2, 1, 30674, 20, 1}, 0},
		{1, 5000, "Vow of the Same Will", {2, 1, 30913, 1, 1}, 0},
		{1, 4999, "§¹i Nh©n s©m", {2, 0, 553, 1, 4}, 0},
		{1, 10000, "TiÓu Nh©n s©m qu¶", {2, 0, 552, 1, 4}, 0},
		{1, 20000, "Xiu Zhen Yao Jue", {2, 0, 554, 1, 4}, 0},
...
function wb_BigBoxAward()
	...
	local tAward = {
		{1, 140, "Lingbo Microstep", {0, 112, 78, 1}, 0},
		--{1, 0, "Ê¦ÃÅÕæ¾í°ü¹ü", {2, 1, 30665, 1}, 0},
		{1, 150, "MËt TÞch Tiªu Dao Tµn QuyÓn", {0, 112, 225, 1}, 0},
		{1, 409, "Xiu Zhen Yao Jue", {2, 0, 554, 3}, 0},
		{1, 70, "Qi Lin Scale", 	 {2, 1, 31064, 1}, 0, 0, 0, 1},
		{1, 20, "Vow of the Same Will",  {2, 1, 30913, 5}, 0},
