...
function bkl_box_award()
	local tWeapon_bkl = {
		[1] =	{
				...
				{700, "Lingfeng", 0, 7, 12},
				{700, "Arhat Staff", 0, 8, 97},
				{700, "ThÇn Hµnh",	 0, 9, 86},
				{700, "Hi Nh©n CÇm", 	0,	10, 75},
				{700, "Meng Tiger", 0, 11, 12},
		...
		[5] =	{
				{554, "ThÇn Quy", 0, 0, 15},
				{666, "Khoa Phu",	 0, 1, 54},
				{666, "Painting Shadow", 0, 2, 37},
				{666, "Tower View",	0, 3, 65},
				{555, "Viªn §Ò", 0,	4,	120},
				{666, "Ngäc Trô", 0, 5, 41},
				{555, "Cöu Long Toµn KÝch",	0,	6, 109},
				{679, "BÝch Thñy", 0, 7, 13},
				{555, "Mu Jianlian Staff", 0, 8, 98},
				{666, "Toan Du",	 0, 9, 87},
				{535, "Great Saint Lingering Sound", 	0,	10, 76},
				{679, "Boundless Silver", 0, 11, 13},
		...
		[6] =	{
				...
				{709, "None",	 0, 1, 55},
				{555, "Nha Cöu", 0, 2, 38},
				{709, "Adverse Scale",	0, 3, 66},
				{468, "Eight Shots of Shooting", 0,	4,	121},
				{709, "ThÇn Ch©m", 0, 5, 42},
				{666, "Spear Slave",	0,	6, 110},
				{709, "Thiªn T«n", 0, 7, 14},
				{269, "Apothecary Staff", 0, 8, 99},
				{679, "Th¸i H­",	 0, 9, 88},
				{357, "Withered Wood Dragon Chant", 	0,	10, 77},
