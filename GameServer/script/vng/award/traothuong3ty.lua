...
function TraoThuong2Ty_Menu()
	...
	tinsert(tbSay, "Receive the Happiness prize ("..nHanhPhuc.." prizes)/#TraoThuong3Ty(1)")
	tinsert(tbSay, "Receive the Wellbeing prize ("..nAnKhang.." prizes)/#TraoThuong3Ty(2)")
	tinsert(tbSay, "Receive the Prosperity prize ("..nThinhVuong.." prizes)/#TraoThuong3Ty(3)")
