...
--	:::::::::::::::::::::::: §æi quèc tÞch ::::::::::::::::::::::::::::::::
	if gf_GetTaskByte(TSK_SERVER_ID, TSK_SERVER_ID_CUR) == 94 then
		gf_SetTaskByte(TSK_SERVER_ID, TSK_SERVER_ID_CUR, 93)
	elseif gf_GetTaskByte(TSK_SERVER_ID, TSK_SERVER_ID_CUR) == 95 then
		gf_SetTaskByte(TSK_SERVER_ID, TSK_SERVER_ID_CUR, 93)
...
--	:::::::::::::::::::::::: §æi hé chiÕu =))  ::::::::::::::::::::::::::::::::
	if GetTask(TSK_CHANGE_SERVER) == 94 then
		SetTask(TSK_CHANGE_SERVER, 93)
	elseif GetTask(TSK_CHANGE_SERVER) == 95 then
		SetTask(TSK_CHANGE_SERVER, 93)
