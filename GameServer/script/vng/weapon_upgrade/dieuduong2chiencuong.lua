...
function OnPutinComplete(param)
	...
	-------------------- Check material ----------------------------
	local tbMaterial = {
		[1] = {item={{gdp={2,95,204,1}, name="Thi™n Cang L÷nh"}, {gdp={2,1,30370,1}, name="Thi™n M´n Kim L÷nh"}, {gdp={2,1,1005,5}, name="Chi’n Th«n Hoµn"}, {gdp={2,1,30499,50}, name="Hero's Medal"}}},
		[2] = {item={{gdp={2,95,204,1}, name="Thi™n Cang L÷nh"}, {gdp={2,1,30370,1}, name="Thi™n M´n Kim L÷nh"}, {gdp={2,1,1005,7}, name="Chi’n Th«n Hoµn"}, {gdp={2,1,30499,50}, name="Hero's Medal"}}},
	}
	local nNguyenlieu = 1
