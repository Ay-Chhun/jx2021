...
tbDieuKien = {
						[1] = {--option
									[1] = {1475, "1475 xu vËt phÈm"},	--tabb
									[2] = {3475, "3475 xu vËt phÈm"},	--cdpb
									[3] = {6700, "6700 xu vËt phÈm"},	--xtcv								
								},
						[2] = {--option
									[1] = {--tabb
												[1] = {6250, "6250 gold"},
...
function tuyetanh_box_award()
	...
	local tAward_QuyTy = {
				...
				{31, 9000, "Book_Pet2(1)"},
				{31, 1, "give_HHVD4()"},
				{31, 4000, "award_random_gem_box_1()"},
				{31, 1000, "award_random_gem_box_2()"},
			}		
...
function chieuda_box_award()
	...
	local tAward_QuyTy = {
				...
				{31, 13000, "give_weapon7()"},
				{31, 5000, "give_weapon8()"},
				{1, 1000, "TÈy T©m Th¹ch cÊp 5", {2,1,30525, 1},7 * 24 * 3600},
				{1, 1000, "LuyÖn L« ThiÕt cÊp 5", {2,1,30531, 1},7 * 24 * 3600},
				{31, 8000, "Book_Pet1(2)"},
				{31, 10000, "Book_Pet2(1)"},			
				{31, 8000, "Book_Pet3(1)"},	
				{31, 1, "give_HHVD4()"},
				{31, 1, "give_HHVD5()"},
				{31, 5500, "award_random_gem_box_2()"},
				{31, 1500, "award_random_gem_box_3()"},
			}		
	gf_EventGiveRandAward(tAward_QuyTy, 100000,1,"GIAP NGO BAO RUONG","më r­¬ng thµnh c«ng")	
	--print("\n=====quyty_box_award==========\n")
end
...
function xichtho_box_award()
	...
	local tAward_QuyTy = {
				...
				{1, 2000, "TÈy T©m Th¹ch cÊp 5", {2,1,30525, 1},7 * 24 * 3600},
				{1, 2000, "LuyÖn L« ThiÕt cÊp 5", {2,1,30531, 1},7 * 24 * 3600},
				...
				{31, 6000, "award_random_gem_box_3()"},
				{31, 2000, "award_random_gem_box_4()"},
				{31, 1500, "award_random_gem_box_5()"},
				{1, 1, "Tói trang bÞ Tam D­¬ng Khai Th¸i", {2,1,30911, 1},15 * 24 * 3600},
			}		
	gf_EventGiveRandAward(tAward_QuyTy, 100000,1,"GIAP NGO BAO RUONG","më r­¬ng thµnh c«ng")	
	--print("\n=====quyty_box_award==========\n")
end
...
function award_wuhuang()
	return _award_jingjie(5, 400000000)
end
...
function giapngo()
	...
	tinsert(tSay, "KiÓm tra sè lÇn kÝch ho¹t r­¬ng/check_CountMaDao")
	tinsert(tSay, "Ta ch­a muèn nhËn th­ëng/dialog_over")
	Say(tHeader, getn(tSay), tSay)	
end

function check_CountMaDao()
	local nCount1,nCount2,nCount3 = 0
	nCount1 = VNG_GetTaskPos(TSK_GIAPNGO_1, 4,1)
	nCount2 = VNG_GetTaskPos(TSK_GIAPNGO_1, 9,6)
	nCount3 = VNG_GetTaskPos(TSK_GIAPNGO_2, 4,1)
	local msgTalk = format("C¸c h¹ ®· kÝch ho¹t r­¬ng TuyÖt ¶nh <color=yellow> %d <color> lÇn \n.R­¬ng ChiÕu D¹ <color=red> %d <color> lÇn \n.R­¬ng XÝch Thè <color=green> %d <color> lÇn.", nCount1, nCount2, nCount3)
	Talk(1,"", msgTalk)
end
...
function get_MaDaoThanhCong(nType)
	...
	elseif nType == 3 then
		...
		ModifyExp(2000000000)
		gf_AddItemEx2({2, 1, 30911, 1}, "Tói trang bÞ Tam D­¬ng Khai Th¸i", "GIAP NGO BAO RUONG BK", "Tói trang bÞ Tam D­¬ng Khai Th¸i")
		award_wuhuang()
		give_weapon8()
