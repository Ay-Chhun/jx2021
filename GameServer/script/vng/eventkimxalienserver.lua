...
tbNguyenLieuNop = {
	...
	[11] = {160, {item={{gdp={0,112,78,1}, name="Lingbo Microstep"}, {gdp={2,1,199,1}, name = "Great Silver Note"}}}, "01 L¨ng Ba Vi Bé + 01 §¹i Ng©n PhiÕu (160 ®iÓm)"},
	[12] = {80, {item={{gdp={2,1,30164,39}, name="Longan"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 Nh·n + 19 xu vËt phÈm (80 ®iÓm)"},
	[13] = {80, {item={{gdp={2,1,30165,39}, name="Rambutan"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 Ch«m Ch«m + 19 xu vËt phÈm (80 ®iÓm)"},
	[14] = {80, {item={{gdp={2,1,30166,39}, name="Cam"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 Cam + 19 xu vËt phÈm (80 ®iÓm)"},
	[15] = {80, {item={{gdp={2,1,30167,39}, name="Coconut"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 Dõa + 19 xu vËt phÈm (80 ®iÓm)"},
	[16] = {80, {item={{gdp={2,1,30168,39}, name="Mangosteen"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 M¨ng Côt + 19 xu vËt phÈm (80 ®iÓm)"},
	[17] = {80, {item={{gdp={2,1,30169,39}, name="Pomelo"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 B­ëi + 19 xu vËt phÈm (80 ®iÓm)"},
	[18] = {80, {item={{gdp={2,1,30170,39}, name="Strawberry"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 D©u + 19 xu vËt phÈm (80 ®iÓm)"},
	[19] = {80, {item={{gdp={2,1,30171,39}, name="Banana"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 Chuèi + 19 xu vËt phÈm (80 ®iÓm)"},
	[20] = {80, {item={{gdp={2,1,30172,39}, name="Mango"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 Xoµi + 19 xu vËt phÈm (80 ®iÓm)"},
	[21] = {80, {item={{gdp={2,1,30173,39}, name="Peach"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 §µo + 19 xu vËt phÈm (80 ®iÓm)"},
	[22] = {80, {item={{gdp={2,1,30174,39}, name="Plum"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 MËn + 19 xu vËt phÈm (80 ®iÓm)"},
	[23] = {80, {item={{gdp={2,1,30175,39}, name="Lychee"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 V¶i + 19 xu vËt phÈm (80 ®iÓm)"},
	[24] = {80, {item={{gdp={2,1,30176,39}, name="Apple"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 T¸o + 19 xu vËt phÈm (80 ®iÓm)"},
	[25] = {80, {item={{gdp={2,1,30177,39}, name="Avocado"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 B¬ + 19 xu vËt phÈm (80 ®iÓm)"},
	[26] = {80, {item={{gdp={2,1,30178,39}, name="Papaya"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 §u §ñ + 19 xu vËt phÈm (80 ®iÓm)"},
	[27] = {80, {item={{gdp={2,1,30179,39}, name="Soursop"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 M·ng CÇu + 19 xu vËt phÈm (80 ®iÓm)"},
	[28] = {80, {item={{gdp={2,1,30180,39}, name="Pineapple"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 Khãm + 19 xu vËt phÈm (80 ®iÓm)"},
	[29] = {80, {item={{gdp={2,1,30181,39}, name="Li"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 Lª + 19 xu vËt phÈm (80 ®iÓm)"},
	[30] = {80, {item={{gdp={2,1,30182,39}, name="Langsat"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 Bßn Bon + 19 xu vËt phÈm (80 ®iÓm)"},
	[31] = {80, {item={{gdp={2,1,30183,39}, name="Star Fruit"}, {gdp={2,1,30230,19}, name = "Item Token"}}}, "39 KhÕ + 19 xu vËt phÈm (80 ®iÓm)"},
	...
	[35] = {15, {item={{gdp={2,1,30346,1}, name="M¶nh B¹ch Kim"}, {gdp={2,1,30230,1}, name="Item Token"}}}, "01 M¶nh B¹ch Kim + 01 xu vËt phÈm (15 ®iÓm)"},
	[36] = {30, {item={{gdp={2,1,30342,1}, name="Gold Chest"}}}, "01 Kim R­¬ng (30 ®iÓm)"},
	...
	[39] = {1500, {item={{gdp={2,1,30345,1}, name="Rebirth Pill"}}}, "01 ChuyÓn Sinh §¬n (1,500 ®iÓm)"},
	[40] = {1000, {item={{gdp={2,1,1006,1}, name="Cöu Thiªn V« Cùc §¬n"}, {gdp={2,1,199,1}, name = "Great Silver Note"}}}, "01 Cöu Thiªn V« Cùc §¬n + 01 §¹i Ng©n PhiÕu (1,000 ®iÓm)"},
	[41] = {200, {item={{gdp={2,1,30230,10}, name="Item Token"}}, nExp = 100000000}, "100.000.000 ®iÓm kinh nghiÖm + 10 xu vËt phÈm (200 ®iÓm)"},
}
...
tbPhanThuongCaNhan = {
	...
	[20] = {item={{gdp={0,102,8844,1,1,-1,-1,-1,-1,-1,-1,-1,0}, name = "Huy Hoµng QuËt Khëi"}, {gdp={0,102,8845,1,1,-1,-1,-1,-1,-1,-1,-1,0}, name = "Glory Rise"}}},
}

tbDieuKienNhanThuong = {
	[1] = {150, {item={{gdp={2,1,30230,1}, name = "Item Token"}}}, "50.000.000 ®iÓm kinh nghiÖm + 999 Méc R­¬ng",2,250},
	[2] = {200, {item={{gdp={2,1,30230,20}, name = "Item Token"}}}, "2,000 reputation + 2,000 sect contribution",0,250},
	[3] = {300, {item={{gdp={2,1,30230,30}, name = "Item Token"}}}, "10.000 ®iÓm ch©n khÝ",0,250},
	[4] = {500, {item={{gdp={2,1,30230,10}, name = "Item Token"}}}, "150 TÈy T©m Kho¸ng Th¹ch",2,250},
	[5] = {1000, {item={{gdp={2,1,30230,10}, name = "Item Token"}}}, "150 LuyÖn L« Kho¸ng Th¹ch",2,250},
	[6] = {1500, {item={{gdp={2,1,30230,50}, name = "Item Token"}}}, "15.000 ®iÓm c«ng tr¹ng",0,250},
	[7] = {2000, {item={{gdp={2,1,30230,20}, name = "Item Token"}}}, "200 Nh©n S©m V¹n N¨m",3,250},
	[8] = {2500, {item={{gdp={2,1,30230,6}, name = "Item Token"}}}, "6.000 vâ l©m b¶o h¹p",7,250},
	[9] = {3000, {item={{gdp={2,1,30230,300}, name = "Item Token"}}}, "03 Ch×a Khãa Vµng",4,250},
	[10] = {3500, {item={{gdp={2,1,30230,60}, name = "Item Token"}}}, "06 Qu©n C«ng §¹i",7,250},
	[11] = {4000, {item={{gdp={2,1,30230,400}, name = "Item Token"}}}, "400 Ma Tinh + 100 B¨ng Tinh Th¹ch",3,250},
	[12] = {5000, {item={{gdp={2,1,30230,800}, name = "Item Token"}}}, "09 Qu©n C«ng Huy Hoµng (h¹n sö dông 30 ngµy)",10,250},
	[13] = {6000, {item={{gdp={2,1,30490,2}, name = "Hoµng Kim §¹i Ng©n PhiÕu"}}}, "10 Kim Xµ cÊp 3 sao ngÉu nhiªn",11,250},
	[14] = {8000, {item={{gdp={2,1,30490,2}, name = "Hoµng Kim §¹i Ng©n PhiÕu"}}}, "80 Iron Essence Level 3",8,250},
...
function EventKimXaLienServer_Vote_Done(szAccount,nIndex)
	...
	gf_WriteLogEx(szLogTitle, "nhËn", 1, "support"..tbNguyenLieuNop[nIndex][3])
...
function EventKimXaLienServer_XemDiem()
	...
	Talk(1,"","You currently have in hand <color=yellow>".. nPoint  .." ®iÓm tÝch lòy<color>, hay mau chãng ®æi phÇn th­ëng.")
end
...
function EventKimXaLienServer_MatTichMonPhai20_Done(nIndex)
	...
	gf_WriteLogEx(szLogTitle, "nhËn", 1, tbDieuKienNhanThuong[19][1].." ®iÓm: "..tbDieuKienNhanThuong[19][3])
	Talk(1,"","C¸c h¹ ®· nhËn 1 mËt tÞch siªu cÊp, cã thÓ nhËn tiÕp "..gf_GetTaskByte(TSK_KIMXA_ALLSERVER_POINT, 2).." volume")
end
