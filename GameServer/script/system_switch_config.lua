...
t_switch_config =
{
	...
	{12, 1, "TongMelee"},
	{13, 1, "CardVip"},
	{14, 1, "GemSystem", "Noble Item System"},
	{15, 1, "TaiYi", "¶i PhÇn Thiªn L©m"},
	{16, 0, "StateChess", "Tr­îng KiÕm Thiªn Nhai"},
	{17, 0, "Merit", "C«ng tr¹ng vâ l©m vµ ®iÓm kiÕm hiÖp"},
	{18, 1, "eyt_battle", "Martial Duel Grudge Arena"},
	{19, 0, "kf_newbattle", "Fortress Battle Cross-Server"},
	{20, 1, "HonorTong", "Guild Hall of Fame"},
	{21, 0, "UnUse"},
	{22, 0, "UnUse"},
	{23, 0, "UnUse"},
	{24, 0, "UnUse"},
