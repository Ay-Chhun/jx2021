...
t_isolate_user_batch_watch_list = { --{szEventId, {event_para...}, pfn_elem_handler(tEvent, data, para), ...},
	...
	--ÎÆÊÎÏµÁĞÈÎÎñ
	{"event_mission_task_award", {"pvp", "plant", -1}, fn_elem, {421, "Obtained Moc Tinh", nil, fn_award_items, {1,100,{{"H¹t Gièng ThÇn Méc",{2,1,31090,1,4},1,100}, }}} },
	{"event_mission_stage_finish", {"taiyi", 4}, fn_elem, {424, "Repair method 3", nil, fn_award_items, {1,100,{{"Thñy Tinh",{2,1,31093,1,4},1,100}, }}} },
	{"event_mission_stage_finish", {"taiyihero", 4}, fn_elem, {424, "Repair method 3", nil, fn_award_items, {1,100,{{"Thñy Tinh",{2,1,31093,1,4},1,100}, }}} },
	{"event_mission_stage_finish", {"jiandangyanyun", 1}, fn_elem, {426, "Repair method 4", nil, fn_award_items, {1,100,{{"Háa Tinh",{2,1,31094,1,4},1,100}, }}} },
	{"event_mission_stage_finish", {"jiandangyanyun", 6}, fn_elem, {426, "Repair method 4", nil, fn_award_items, {1,100,{{"Háa Tinh",{2,1,31094,1,4},1,100}, }}} },
	{"event_mission_stage_finish", {"jiandangyanyunhero", 1}, fn_elem, {426, "Repair method 4", nil, fn_award_items, {1,100,{{"Háa Tinh",{2,1,31094,1,4},1,100}, }}} },
	{"event_mission_stage_finish", {"jiandangyanyunhero", 6}, fn_elem, {426, "Repair method 4", nil, fn_award_items, {1,100,{{"Háa Tinh",{2,1,31094,1,4},1,100}, }}} },
	{"event_mission_stage_finish", {"jiandangyanyun", 3}, fn_elem, {426, "Repair method 4", nil, fn_award_items, {1,100,{{"Tho Tinh",{2,1,31095,1,4},1,100}, }}} },
	{"event_mission_stage_finish", {"jiandangyanyun", 6}, fn_elem, {426, "Repair method 4", nil, fn_award_items, {1,100,{{"Tho Tinh",{2,1,31095,1,4},1,100}, }}} },
	{"event_mission_stage_finish", {"jiandangyanyunhero", 3}, fn_elem, {426, "Repair method 4", nil, fn_award_items, {1,100,{{"Tho Tinh",{2,1,31095,1,4},1,100}, }}} },
	{"event_mission_stage_finish", {"jiandangyanyunhero", 6}, fn_elem, {426, "Repair method 4", nil, fn_award_items, {1,100,{{"Tho Tinh",{2,1,31095,1,4},1,100}, }}} },
	...
	{"event_mission_stage_finish", {"jiandangyanyun", 5}, fn_elem, {466, "Thiªn ¢m rót lui", nil, fn_award_items, {1,100,{{"Huyet Moc Seal",{2,1,31116,1,4},1,100}, }}} },
	...
	{"event_mission_stage_finish", {"jiandangyanyunhero", 5}, fn_elem, {466, "Thiªn ¢m rót lui", nil, fn_award_items, {1,100,{{"Huyet Moc Seal",{2,1,31116,1,4},1,100}, }}} },
	...
	{"event_mission_stage_finish", {"jiandangyanyun", 6}, fn_elem, {466, "Thiªn ¢m rót lui", nil, fn_award_items, {1,100,{{"Huyet Moc Seal",{2,1,31116,1,4},1,100}, }}} },
	...
	{"event_mission_stage_finish", {"jiandangyanyunhero", 6}, fn_elem, {466, "Thiªn ¢m rót lui", nil, fn_award_items, {1,100,{{"Huyet Moc Seal",{2,1,31116,1,4},1,100}, }}} },
	...
	{"event_mission_task_award", {"pvp","duobiao",5}, fn_elem, {470, "Tiªu Xa Hoµng Gia", nil, fn_award_items, {1,100,{{"Relief Supplies",{2,1,31144,1,4},1,100}, }}} },
}
