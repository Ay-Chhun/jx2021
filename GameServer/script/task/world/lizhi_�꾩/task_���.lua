...
function main()
    local szTalk= {
        ...
        "Insolent thieving cur! I have come to rescue Elder Bai!",
...
function bcw_talk()
    local szTalk = {
        ...
        "Please take a look, elder!",
        "[Old Master Baicao quickly reads the secret letter]"
    };
...
function bcw_talk_1()
    local szTalk = {
        ...
        "Then please take care of yourself, elder! I am off!"
    };
    TalkEx("", szTalk);
end;
