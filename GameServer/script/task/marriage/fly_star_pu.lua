...
--================================¹«¹²±äÁ¿¶¨ÒåÇø================================
	...
	Tb_goods_compose = {}
	Tb_goods_compose[583] = {{573,"§ång T©m Hoµn","Sö dông trŞ §ång t©m t¨ng <color=yellow>125<color> ®iÓm!","trŞ §ång t©m t¨ng 125 ®iÓm"},{568,6,"Gi¸p Méc d­¬ng"},{569,2,"Yi Wood Yin"},{570,1,"Bing Fire Yang"}}
	Tb_goods_compose[584] = {{574,"§¹i §ång T©m Hoµn","Sö dông trŞ §ång t©m t¨ng <color=yellow>300<color> ®iÓm!","trŞ §ång t©m t¨ng 300 ®iÓm"},{568,9,"Gi¸p Méc d­¬ng"},{569,5,"Yi Wood Yin"},{570,2,"Bing Fire Yang"}}
	Tb_goods_compose[585] = {{575,"§ång T©m ®¬n","Sö dông trŞ §ång t©m t¨ng <color=yellow>125<color> ®iÓm!","TrŞ §ång T©m t¨ng tèi ®a 125 ®iÓm"},{568,3,"Gi¸p Méc d­¬ng"},{569,4,"Yi Wood Yin"},{570,2,"Bing Fire Yang"}}
	Tb_goods_compose[586] = {{576,"§¹i §ång T©m ®¬n","Sö dông trŞ §ång t©m t¨ng <color=yellow>300<color> ®iÓm!","TrŞ §ång T©m t¨ng tèi ®a 300 ®iÓm"},{568,4,"Gi¸p Méc d­¬ng"},{569,8,"Yi Wood Yin"},{570,4,"Bing Fire Yang"}}
...
function star_att_inq()
	...
	player_sex = GetSex()
	Talk(1,"","<color=green>Chó ı<color>: ı trung nh©n cña b¹n sö dông <color=yellow>Khiªn V©n Phi Tinh phæ<color> t×m thÊy 1 täa ®é L­u tinh: <color=yellow>"..Tb_player_sex_att[player_sex][1].."<color> the coordinate is <color=red>"..Tb_task_reel_att[map_ID_save][att_seq_save][player_sex].."<color>. §Õn ®­îc täa ®é nhí nh¾c ı trung nh©n lµm 1 ®éng t¸c t×nh tø, sÏ nhËn ®­îc to¸i phiÕn!")
	PlayerIndex = player_index_save	
end
--*************************ËéÆ¬È¡³ö****************************
...
function get_att()
	...
	PlayerIndex = player_mate_index
	player_sex = GetSex()
	Talk(1,"","<color=green>Chó ı<color>: ı trung nh©n cña b¹n sö dông <color=yellow>Khiªn V©n Phi Tinh phæ<color>, nhËn ®­îc 1 täa ®é to¸i phiÕn, <color=yellow>"..Tb_player_sex_att[player_sex][1].."<color> the coordinate is <color=yellow>"..Tb_task_reel_att[map_id][att_seq][player_sex].."<color> §Õn ®­îc täa ®é xin nh¾c ı trung nh©n cña b¹n <color=yellow>lµm 1 ®éng t¸c t×nh tø bÊt kú<color> sÏ <color=yellow> nhËn ®­îc To¸i phiÕn<color>")
	Msg2Player("ı trung nh©n cña b¹n sö dông Khiªn V©n Phi Tinh phæ, nhËn ®­îc 1 täa ®é to¸i phiÕn, "..Tb_player_sex_att[player_sex][1].." the coordinate is"..Tb_task_reel_att[map_id][att_seq][player_sex].."§Õn ®­îc täa ®é nhí nh¾c ı trung nh©n lµm 1 ®éng t¸c t×nh tø, sÏ nhËn ®­îc to¸i phiÕn!")
	PlayerIndex = player_index_save	
end
--***********************±¦ÎïºÏ³É¶Ô»°**************************
