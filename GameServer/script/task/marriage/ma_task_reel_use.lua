...
function OnUse(goods_index)
	...
	Say("<color=green>Gîi ı<color>: Sö dông"..Tb_ma_task_reel[goods_diff][2].." cã thÓ t¨ng täa ®é L­u tinh trong <color=yellow>Khiªn V©n Phi Tinh Phæ<color> <color=yellow>"..Tb_ma_task_reel[goods_diff][3].."<color>. Really?",
	2,
