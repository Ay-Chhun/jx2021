...
function GivePlayerAward_Bg(index)
    ...
    if nDist >= 0 and nDist <= 15 then
    	Say("<color=green>¢m thanh thÇn bÝ<color>: Tr­íc khi khai quËt kho b¸u xem <color=yellow>®ñ søc lùc vµ kho¶ng trèng<color> ch­a! Muèn tiÕp tôc kh«ng?",2,"Continue!/#GiveAward("..index..")", "Stop!/empty_function");
    else
