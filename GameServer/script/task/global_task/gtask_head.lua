	...
	--print("MeridianGetLevel")
		...
		if MeridianUpdateLevel() == 1 then
			...
			if MeridianGetLevel() == 1 then
	  		...
	  		Msg2Player("Congratulations"..tSex.."So bé l·nh ngé <Quú Hoa B¶o §iÓn>, nhËn ®­îc 30000 ®iÓm ch©n khİ");
	  		Talk(2,"",format("Chóc mõng <color=green>%s<color>®· ®äc'Quú Hoa B¶o §iÓn'thµnh c«ng vµ ®Æt  ®Õn c¹nh giíi vâ gi¶",tSex),format("Chóc mõng %s s¬ bé lÜnh ngé ®­îc'Quú Hoa B¶o §iÓn',nhËn ®­îc<color=green>30000<color>®iÓm Ch©n Khİ (bÊm nót J®Ó xem kinh m¹ch)",tSex));
			end
		end
	end
end
