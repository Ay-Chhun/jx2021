...
--	3 lo¹i r­¬ng
	...
	if DelItem(2,1,1087,1) == 1 then
		...
		if nType1 ~= 0 then
			...
			Msg2Player("Received"..tExpAward[7].." ®iÓm kinh nghiÖm!")
			gf_WriteLogEx("Nhiem vu STD", "nhËn "..tExpAward[7].." ®iÓm kinh nghiÖm")
			gf_AddItemEx2({2,1,30164+mod(random(1,1000),20),3}, "Fruit", "Nhiem vu STD", "nhËn")
			gf_AddItemEx2({2,1,30498,1}, "Brave Warrior Medal", "Nhiem vu STD", "nhËn")
		--- §iÓm VËn May
...
--			end
		...
		if nType2 ~= 0 then
			...
			Msg2Player("Received"..tExpAward[8].." ®iÓm kinh nghiÖm!")
			gf_WriteLogEx("Nhiem vu STD", "nhËn "..tExpAward[8].." ®iÓm kinh nghiÖm")
			gf_AddItemEx2({2,1,30164+mod(random(1,1000),20),4}, "Fruit", "Nhiem vu STD", "nhËn")
			gf_AddItemEx2({2,1,30498,1}, "Brave Warrior Medal", "Nhiem vu STD", "nhËn")
		--- §iÓm VËn May
--			local nPointVM = gf_GetTaskByte(TSK_LUCKY_DAOHUU_NEW_THANG4, BYTE_POINT_LUCKY)	
...
--			end
		...
		if nType3 ~= 0 then
			...
			Msg2Player("Received"..tExpAward[9].." ®iÓm kinh nghiÖm!")
			gf_WriteLogEx("Nhiem vu STD", "nhËn "..tExpAward[9].." ®iÓm kinh nghiÖm")
			gf_AddItemEx2({2,1,30164+mod(random(1,1000),20),5}, "Fruit", "Nhiem vu STD", "nhËn")
			gf_AddItemEx2({2,1,30498,2}, "Brave Warrior Medal", "Nhiem vu STD", "nhËn")
		--- §iÓm VËn May
--			local nPointVM = gf_GetTaskByte(TSK_LUCKY_DAOHUU_NEW_THANG4, BYTE_POINT_LUCKY)	
...
--	3 lo¹i r­¬ng
	...
	if DelItem(2,1,1087,3) == 1 and  DelItem(2,1,30230,99) == 1 then
		...
		if nType1 ~= 0 then
			...
			Msg2Player("Received"..tExpAward[7].." ®iÓm kinh nghiÖm!")
			gf_WriteLogEx("Nhiem vu STD", "nhËn "..tExpAward[7].." ®iÓm kinh nghiÖm")
			gf_AddItemEx2({2,1,30164+mod(random(1,1000),20),6}, "Fruit", "Nhiem vu STD", "nhËn")
		--- §iÓm VËn May
--			local nPointVM = gf_GetTaskByte(TSK_LUCKY_DAOHUU_NEW_THANG4, BYTE_POINT_LUCKY)	
--			local nExpVM = (nPointVM - 100)/100*tExpAward[7]
--			ModifyExp(nExpVM)
...
--			end
		...
		if nType2 ~= 0 then
			...
			Msg2Player("Received"..tExpAward[8].." ®iÓm kinh nghiÖm!")
			gf_WriteLogEx("Nhiem vu STD", "nhËn "..tExpAward[8].." ®iÓm kinh nghiÖm")
			gf_AddItemEx2({2,1,30164+mod(random(1,1000),20),8}, "Fruit", "Nhiem vu STD", "nhËn")
			gf_AddItemEx2({2,1,30499,1}, "Hero's Medal", "Nhiem vu STD", "nhËn")
		--- §iÓm VËn May
--			local nPointVM = gf_GetTaskByte(TSK_LUCKY_DAOHUU_NEW_THANG4, BYTE_POINT_LUCKY)	
--			local nExpVM = (nPointVM - 100)/100*tExpAward[8]
--			ModifyExp(nExpVM)
...
--			end
		...
		if nType3 ~= 0 then
			...
			Msg2Player("Received"..tExpAward[9].." ®iÓm kinh nghiÖm!")
			gf_WriteLogEx("Nhiem vu STD", "nhËn "..tExpAward[9].." ®iÓm kinh nghiÖm")
			gf_AddItemEx2({2,1,30164+mod(random(1,1000),20),10}, "Fruit", "Nhiem vu STD", "nhËn")
			gf_AddItemEx2({2,1,30499,1}, "Hero's Medal", "Nhiem vu STD", "nhËn")	
		--- §iÓm VËn May
--			local nPointVM = gf_GetTaskByte(TSK_LUCKY_DAOHUU_NEW_THANG4, BYTE_POINT_LUCKY)	
--			local nExpVM = (nPointVM - 100)/100*tExpAward[9]
