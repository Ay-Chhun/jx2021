...
function confirm_use_baiju(BaijuType)
	if BaijuType == 0 then
		Say("X¸c ®Şnh sö dông <color=yellow>B¹ch CÇu Hoµn<color> quy ®æi thµnh ®iÓm kinh nghiÖm?", 3, "Agree/yes_get_offline_baiju", "trë l¹i/get_offline_baiju", "Leave/no")
	elseif BaijuType == 1 then
		Say("X¸c ®Şnh sö dông <color=yellow>§¹i B¹ch CÇu Hoµn<color> quy ®æi thµnh ®iÓm kinh nghiÖm?", 3, "Agree/yes_get_offline_baiju1", "trë l¹i/get_offline_baiju", "Leave/no")
	elseif BaijuType == 2 then
		Say("X¸c ®Şnh sö dông <color=yellow>B¹ch CÇu Tiªn §¬n<color> quy ®æi thµnh ®iÓm kinh nghiÖm?", 3, "Agree/yes_get_offline_baiju2", "trë l¹i/get_offline_baiju", "Leave/no")
	end
end
...
function confirm_use_liushen(LiushenType)
	if LiushenType == 0 then
		Say("X¸c ®Şnh sö dông <color=yellow>Lôc ThÇn Hoµn<color> quy ®æi thµnh ®iÓm danh väng?", 3, "Agree/yes_get_offline_liushen", "trë l¹i/get_offline_liushen", "Leave/no")
	elseif LiushenType == 1 then
		Say("X¸c ®Şnh sö dông <color=yellow>C­êng HiÖu Lôc ThÇn Hoµn<color> quy ®æi thµnh ®iÓm danh väng?", 3, "Agree/yes_get_offline_liushen1", "trë l¹i/get_offline_liushen", "Leave/no")
	elseif LiushenType == 2 then
		Say("X¸c ®Şnh sö dông <color=yellow>Lôc ThÇn Tiªn §¬n<color> quy ®æi thµnh ®iÓm danh väng?", 3, "Agree/yes_get_offline_liushen2", "trë l¹i/get_offline_liushen", "Leave/no")
	end
end
...
function confirm_use_sanqing(SanqingType)
	if SanqingType == 0 then
		Say("X¸c ®Şnh sö dông <color=yellow>Tam Thanh Hoµn<color> ®æi ®iÓm Cèng HiÕn S­ M«n?", 3, "Agree/yes_get_offline_sanqing", "trë l¹i/get_offline_sanqing", "Leave/no")
	elseif SanqingType == 1 then
		Say("X¸c ®Şnh sö dông <color=yellow>C­êng HiÖu Tam Thanh Hoµn<color> ®æi ®iÓm Cèng HiÕn S­ M«n?", 3, "Agree/yes_get_offline_sanqing1", "trë l¹i/get_offline_sanqing", "Leave/no")
	elseif SanqingType == 2 then
		Say("X¸c ®Şnh sö dông <color=yellow>Tam Thanh Tiªn §¬n<color> ®æi ®iÓm Cèng HiÕn S­ M«n?", 3, "Agree/yes_get_offline_sanqing2", "trë l¹i/get_offline_sanqing", "Leave/no")
	end
end
