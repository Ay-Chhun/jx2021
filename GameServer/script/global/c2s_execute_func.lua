...
function auto_lock_confirm_2(nParam)
	...
	WriteLog("[Khãa giao dÞch]"..GetName().."ThiÕt lËp khãa giao dÞch, thêi gian khãa lµ "..nParam.." minutes, login IP"..nCurip..".");
	if (nParam <= 0) then
		Talk(1,"","Khãa giao dÞch: B¹n ®· hñy chøc n¨ng khãa giao dÞch!");
	else
		Talk(1,"","Khãa giao dÞch: B¹n ®· chän thiÕt lËp thêi gian khãa giao dÞch tù ®éng <color=red>"..nParam.." minutes<color>!");
	end
end
...
function confirm_1_time(nParam)
	...
	Say("Khãa giao dÞch: B¹n chän khãa giao dÞch <color=red>"..nParam.."<color> giê, tõ <color=red>"..month.."NguyÖt"..day.."day"..hour.." ®iÓm"..minute.." minutes to"..month1.."NguyÖt"..day1.."day"..hour1.." ®iÓm"..minute.." phót<color>, b¹n x¸c nhËn muèn khãa?",
		2,
