...
function GLB_BW_AskChange(nType)
	...
	Say("QuyÕt ®Şnh dïng <color=yellow>"..tBwChangeItem[nType][1].." ®iÓm<color>"..g_TempItemName.."Exchange <color=yellow>"..tBwChangeItem[nType][2][2].."<color> ?",
		3,
