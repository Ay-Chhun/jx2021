...
function OnUse()
	Say("Sau khi dïng <color=yellow>MËt chÕ TÈy Tïy ®¬n<color> cã thÓ c¶i t¹o 5 ®iÓm n¨ng lùc c¬ b¶n, b¹n muèn c¶i t¹o n¨ng lùc c¬ b¶n nµo?",
		6,
		"Strength/change_strength_5_points",
		"Néi c«ng /change_energy_5_points",
		"Vitality/change_vitality_5_points",
		"Dexterity/change_dexterity_5_points",
