...
--ÎïÆ·´óÀà£¬¸±Àà£¬ÏêÏ¸Àà±ğ£¬ĞèÒªÉùÍû£¬³ÆºÅÃû³Æ£¬¶ÔÓ¦³ÆºÅ±íÄÚµÄ´óÀà£¬¸±Àà£¬³ÖĞøÊ±¼ä(ÕæÊµÊ±¼ä)
	...
	{2,1,1038,	2000 ,	"Martial World Brave Hero",	22,	8 ,	3600 * 24 * 30},
	...
	{2,1,1042,	10000,	"Unrivaled Hero of the Age",	22,	12,	3600 * 24 * 30},	
	{2,1,1043,	15000,	"Foremost Grand Master of a Generation",	22,	13,	3600 * 24 * 30},	
	{2,1,1044,	24000,	"Vâ l©m ®Ö nhÊt",	22,	14,	3600 * 24 * 30},	
	{2,1,1045,	35000,	"Peerless Expert of the Age",	22,	15,	3600 * 24 * 30},	
...
function OnUse(nidx)
	...
	Say("NÕu danh väng cña b¹n ®¹t ®Õn <color=yellow>"..tTab[nTabIndex][5].."<color> sÏ cã th«ng b¸o réng r·i trong giang hå, muèn sö dông?", 2, "Yes/#yes_say("..nTabIndex..")", "Sai/no_say")
end
...
function yes_say(nTabIndex)
	...
	if nRet < tTab[nTabIndex][4] then
		Say("Position"..GetPlayerSex()..", danh väng cña b¹n ch­a ®¹t cÊp ®é nµy!", 0)
