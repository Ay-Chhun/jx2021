...
function OnUse(nItemIdx)
	...
	if gf_JudgeRoomWeight(g_NeedRoom,g_NeedWeight) == 1 then
		if DelItemByIndex(nItemIdx,1) == 1 then
			...
			give_item(2,0,554,1,"1 copy of the Cultivation Essence Secret",10,2,0);  --ĞŞÕæÒª¾÷1±¾£¬10%ÇÒÃ¿¿ª2¸ö°ü±Ø¸ø1¸ö	
			...
			give_item(2,1,3206,1,"1 Wulin Treasure Manual",0.1,160,1);	--1±¾ÎäÁÖ±¦µä,0.1%ÇÒÃ¿¿ª160¸ö°ü±Ø¸ø1¸ö
