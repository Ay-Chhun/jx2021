...
function confirm_open(nItemIdx)
	...
	Say("<color=red> Chó ı<color>: R­¬ng b¹n ph¶i cã "..g_NeedRoom.." empty slots and"..g_NeedWeight.." søc lùc. Linh Th¹ch vµ Linh Th¹ch Phèi Ph­¬ng sÏ tô hîp t¹i Tô Linh §Ønh. Xin h·y chó ı Danh Väng hiÖn t¹i cña b¹n, ®iÓm cèng hiÕn S­ M«n ph¶i ®¹t tèi ®a, nÕu nh­ sè l­îng tói më ®­îc v­ît qu¸ giíi h¹n, hÖ thèng sÏ tù ®éng khÊu trõ. QuyÕt ®Şnh më ngay b©y giê chø?",getn(selTab),selTab);
end
...
function open(nItemIdx)
	...
	if gf_JudgeRoomWeight(g_NeedRoom,g_NeedWeight) == 1 then
		if DelItemByIndex(nItemIdx,1) == 1 then
			...
			give_item(2,1,1056,1,"1 Farming Manual",0.5,80,1);	--Å©É£¼­Òª,0.5%ÇÒÃ¿¿ª80¸ö°ü±Ø¸øÒ»¸ö
