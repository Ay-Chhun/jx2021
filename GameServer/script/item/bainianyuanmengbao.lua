...
function OnUse(nItemIdx)
	...
	if gf_JudgeRoomWeight(g_NeedRoom,g_NeedWeight) == 1 then
		if DelItemByIndex(nItemIdx,1) == 1 then
			...
			give_item(2,0,554,1,"1 copy of the Cultivation Essence Secret",10,2,0);  --1±¾ÐÞÕæÒª¾÷£¬10%ÇÒÃ¿¿ª2¸ö°ü±Ø¸ø1¸ö	
			give_item(2,1,2002,1,"1 month",5,8,0);  --1¸öÔÂ»ª£¬5%ÇÒÃ¿¿ª8¸ö°ü±Ø¸ø1¸ö
