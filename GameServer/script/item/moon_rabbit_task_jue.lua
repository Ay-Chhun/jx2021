...
jue_list = {
		...
		{"Lesser Yin Art",2,6,115},
		{"B¾c §Èu TrËn quyÕt",2,6,116},
		{"Fading Shadow Art",2,6,117},
		{"Universe Art",2,6,118},
		...
		{"Thao Thi Thuat secret manual",2,6,144},
		{"Thi Doc Thuat secret manual",2,6,145},
		{"Bİ kiÕp Thi Béc §¹i Ph¸p",2,6,146},
		{"Tap Thi Ta Khi secret manual",2,6,147},
		{"Ngu Thi Thuat secret manual",2,6,148},
		{"Bİ kiÕp V¹n §éc §o¹t MÖnh §ao",2,6,149},
		{"Bİ kiÕp ¢m Tµ HÊp Hån Khİ",2,6,150},
		{"Thoi Thi Ta Khi secret manual",2,6,151},
		{"Bİ kiÕp Tµ Linh §¹i Ph¸p",2,6,152},
		{"Bİ kiÕp Tµ §éc C«ng",2,6,153},
		{"Bİ kiÕp Thi LiÖt Ma C«ng",2,6,154},
		{"Bİ kiÕp H¹ Cæ MËt Ph­¬ng",2,6,155},
		{"Phong Co secret manual",2,6,156},
		{"Duong Co Bi Thuat secret manual",2,6,157},
		{"Bİ kiÕp Cuång Phong Tr¶o",2,6,158},
		{"Doc Co secret manual",2,6,159},
		{"Bİ kiÕp HuyÕt §Ønh C«ng",2,6,160},
		{"Huyet Co secret manual",2,6,161},
		{"Huong Co secret manual",2,6,162},
		{"Thi Co secret manual",2,6,163},
		{"Yeu Co secret manual",2,6,164},
		{"Bİ kiÕp T©m Cæ",2,6,165},
		{"Bİ kiÕp V¹n Cæ Thùc Thiªn",2,6,166},
		{"Huyen Co secret manual",2,6,167},
		{"Tam Co secret manual",2,6,168}},
}
jue_id = {	{607,"Shaolin secret manual bag"},
			{608,"Tói bİ kiÕp §­êng M«n"},
			{609,"Emei secret manual bag"},
			{610,"Beggars' Sect secret manual bag"},
			{611,"Wudang secret manual bag"},
			{612,"Tói bİ kiÕp D­¬ng M«n"},
			{613,"Five Poisons secret manual bag"}}
--==================================½Å±¾Ö÷Âß¼­Çø=============================
function OnUse(goods_index)
	...
	"Exchange/#goods_use_det("..goods_diff..")",
