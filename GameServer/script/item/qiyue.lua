...
function OnUse()
	...
	if nNpcCount > 100 then
		Say("BiÓn ng­êi ®«ng nghÞt, biÕt t×m ë ®©u ®©y"..GetPlayerSex().."Go gather somewhere else!", 0)
		return
	end
...
function use_shennong()
	Say("May I ask"..GetPlayerSex().."cÇn dïng mÊy viªn ThÇn N«ng ®¬n ®Ó ñy th¸c thu thËp?",
		4,
		"Dïng 1 ThÇn N«ng ®¬n--nhËn ®­îc 8 giê ñy th¸c thu thËp (thu phÝ "..GOLD_PER_8_HOUR.." gold)/#yes_use(1)",
		"Dïng 2 ThÇn N«ng ®¬n--nhËn ®­îc 16 giê ñy th¸c thu thËp (thu phÝ "..(GOLD_PER_8_HOUR * 2).." gold)/#yes_use(2)",
		"Dïng 3 ThÇn N«ng ®¬n--nhËn ®­îc 24 giê ñy th¸c thu thËp (thu phÝ "..(GOLD_PER_8_HOUR * 3).." gold)/#yes_use(3)",
