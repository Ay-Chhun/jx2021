...
function OnUse()
	...
	if IB_VERSION == 1 then
		szExp = "Received <color=yellow>"..floor(1000000*(nLevel^3)/(80^3)).." kinh nghiÖm <color>. ";
	else
		szExp = "Received <color=yellow>"..floor(1500000*(nLevel^3)/(80^3)).."Kinh nghiÖm kháe m¹nh <color>, ChuyÓn <color=yellow> "..floor(2500000*(nLevel^3)/(80^3)).." ®iÓm <color>. ";
	end;	
