...
if ( UWorld1402 == 50  )  then
		Talk(2,"","S­ phô ch¾c lµ HuyÒn DiÖt T«n Gi¶! D­¬ng NguyÖt s­ th¸i tiÕn cö ta ®Õn ®iÒu tra viÖc Phong §« Quû thµnh ®ét nhiªn xuÊt hiÖn ë Giang T©n Th«n. Víi søc lùc cña S­ th¸i kÕt hîp víi X¸ Lîi kim ®¬n vÉn ch­a ®ñ cÇn ®­îc sù gióp ®ì cña s­ phô!","Ra lµ vËy! Kh«ng ngê Phong §« Quû thµnh l¹i xuÊt hiÖn ë nh©n gian. Thİ chñ h·y gióp ta t×m <color=red>2 x©u Thiªn PhËt ch©u<color> vÒ tr­íc ®·!","This humble one goes now!")
		SetTask(1402,55)
		--AddItem(1,1,1,1)
		Earn(800)
...
elseif ( UWorld1402  == 55 and GetItemCount(2,3,4) >= 2 ) then
		if  DelItem(2,3,4,1) == 1 then
				Talk(5,"","Thiªn PhËt ch©u ®©y!","CÊt mét c¸i ®i ta sÏ phï phĞp c¸i kia ®Ó yªu ma kh«ng nhËp ®­îc vµo ng­¬i. Nhí lÊy! PhĞp thuËt ta chØ gióp ng­êi phßng th©n chø kh«ng thÓ ®i l¹i trong Quû thµnh.","VËy ph¶i lµm sao?","Ng­¬i ph¶i ®Õn <color=red>Vâ §ang<color> t×m <color=red>TËp Nguyªn ch©n nh©n<color> thØnh <color=red>§én Èn linh phï<color> míi cã thÓ ®i l¹i trong Quû thµnh.","This humble one goes now!") 
				SetTask(1402,60)
				--AddItem(1,1,1,1)
				Earn(1000)
