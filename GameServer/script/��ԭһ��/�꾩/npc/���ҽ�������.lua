function main()
	if GetPlayerFaction() == 3  then
		Say("S­ muéi muèn trë vÒ ph¶i kh«ng?!",3,"Bother senior martial sister!/gotoemei","T×m hiÓu khu vùc luyÖn cÊp/maphelp","GhĞ th¨m S­ tû th«i mµ!Kh«ng cÇn/no")
	...
	elseif GetPlayerFaction() == 5 then
		...
		Say("Thİ chñ t×m bÇn ni cã chuyÖn g×?",2,"Ta muèn tham quan Nga My/gotoemei","Nothing at all!/no")
	end
end
