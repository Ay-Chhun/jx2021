...
function main()
	if GetPlayerFaction() == 1  then
		Say("S­ phô ph¸i s­ ®Ö xuèng nói µ?",3,"May I trouble you, brother, to take me down the mountain!/gotoshaolin","T×m hiÓu khu vùc luyÖn cÊp/maphelp","Let me pay respects to the master for you!/no")
	...
	elseif GetPlayerFaction() == 5 then
		...
		Say("Thİ chñ t×m tiÓu t¨ng cã viÖc chi?",2,"Ta muèn tham quan ThiÕu L©m/gotoshaolin","Nothing at all!/no")
	end
end
