...
function beforelearnskill(id)
	if (id == 124) then	--´ò¹·¹÷Õó
		if (GetSkillLevel("Dog Beating Staff Technique") <= 0) then
...
function afterlearnskill(id)
	if (id == 124) then	--´ò¹·¹÷Õó
		if (GetSkillLevel("Dog Beating Staff Technique") == 1) then
		...
		elseif (GetSkillLevel("Dog Beating Staff Technique") == 5) then
