...
function OnUse(goods_index)
	if GetLevel() < 11 then
		Talk(1,"","<color=green>Reminder<color>:"..Zgc_pub_sex_name().."cÇn rÌn luyÖn thªm mét thêi gian!")
		return
	end
