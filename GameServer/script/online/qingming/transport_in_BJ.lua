...
function main()
	...
	elseif tomb_sweep_2007_date_chk() == 0 then
		...
		Say("<color> During the Qingming Festival,"..Zgc_pub_sex_name().."cã muèn ®Õn mé phÇn cña <color=red>Hµn ®¹i hiÖp<color> b¸i tÕ bµy tá thµnh ı kh«ng?",getn(selTab),selTab);
	end;
end;
