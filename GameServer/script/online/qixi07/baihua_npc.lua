...
function give_them_award(nType)
	...
	if GetTeamSize() ~= 2 then
		...
		if nRandExp >= 99 then
			...
			nNumOne = nNumOne*3;
			nNumTwo = nNumTwo*3;
			Msg2Global("Congratulations"..sNameOne.."Trong ho¹t ®éng mõng 8-3 nhËn ®­îc phÇn th­ëng kinh nghiÖm gÊp 3 lÇn");
			Msg2Global("Congratulations"..sNameTwo.."Trong ho¹t ®éng mõng 8-3 nhËn ®­îc phÇn th­ëng kinh nghiÖm gÊp 3 lÇn");
		elseif nRandExp >= 96 then
			nExpOne = nExpOne*2;
			nExpTwo = nExpTwo*2;
			nNumOne = nNumOne*2;
			nNumTwo = nNumTwo*2;
			Msg2Global("Congratulations"..sNameOne.."Trong ho¹t ®éng mõng 8-3 nhËn ®­îc phÇn th­ëng kinh nghiÖm gÊp 2 lÇn!");
			Msg2Global("Congratulations"..sNameTwo.."Trong ho¹t ®éng mõng 8-3 nhËn ®­îc phÇn th­ëng kinh nghiÖm gÊp 2 lÇn!");			
		end		
		if nLvOne ~= 99 then		
			ModifyExp(nExpOne);
...
function confirm_sanba_award(nType)
	...
	if nRandExp >= 99 then
		nExp = nExp*3;
		nLingshiNum = nLingshiNum*3;
		Msg2Global("Congratulations"..sName.."Trong ho¹t ®éng mõng 8-3 nhËn ®­îc phÇn th­ëng kinh nghiÖm gÊp 3 lÇn");
	elseif nRandExp >= 96 then
		nExp = nExp*2;
		nLingshiNum = nLingshiNum*2;
		Msg2Global("Congratulations"..sName.."Trong ho¹t ®éng mõng 8-3 nhËn ®­îc phÇn th­ëng kinh nghiÖm gÊp 2 lÇn!");	
	end	
	if nLv ~= 99 then
		ModifyExp(nExp);
