		...
		if nRand <= tb[nType][nTbIdx] then
			if nTbIdx == 1 then
				...
				if nAddFlag == 1 then
					...
					WriteLog("[Ho¹t ®éng Kû niÖm 20 n¨m]: Ng­êi ch¬i "..GetName().."Sö dông "..tItemName[nType+6][1].."Open"..tItemName[6][1].."Received"..tItemName[nChoose][1].." thÊt b¹i, kı hiÖu:"..nAddFlag);
				end				
			elseif nTbIdx == 2 then
				...
				if nAddFlag == 1 then
					...
					WriteLog("[Ho¹t ®éng Kû niÖm 20 n¨m]: Ng­êi ch¬i "..GetName().."Sö dông "..tItemName[nType+6][1].."Open"..tItemName[6][1].."Received"..tGaojiMiji[nRoute][nRandMiji][1].." thÊt b¹i, kı hiÖu:"..nAddFlag);
				end				
			...
			elseif nTbIdx == 4 then
				...
				if nAddFlag == 1 then
					...
					WriteLog("[Ho¹t ®éng Kû niÖm 20 n¨m]: Ng­êi ch¬i "..GetName().."Sö dông "..tItemName[nType+6][1].."Open"..tItemName[6][1].."Received"..tItemName[5][1].." thÊt b¹i, kı hiÖu:"..nAddFlag);
				end					
			elseif nTbIdx == 5 then
				if IB_VERSION == 1 then
					...
					if nAddFlag == 1 then
						...
						WriteLog("[Ho¹t ®éng Kû niÖm 20 n¨m]: Ng­êi ch¬i "..GetName().."Sö dông "..tItemName[nType+6][1].."Open"..tItemName[6][1].."Received"..tItemName[12][1].." thÊt b¹i, kı hiÖu:"..nAddFlag);
					end															
				else
					...
					if nAddFlag == 1 then
						...
						WriteLog("[Ho¹t ®éng Kû niÖm 20 n¨m]: Ng­êi ch¬i "..GetName().."Sö dông "..tItemName[nType+6][1].."Open"..tItemName[6][1].."Received"..tItemName[13][1].." thÊt b¹i, kı hiÖu:"..nAddFlag);
					end										
				end
			elseif nTbIdx == 6 then
				...
				if nAddFlag == 2 then
					...
					WriteLog("[Ho¹t ®éng Kû niÖm 20 n¨m]: Ng­êi ch¬i "..GetName().."Sö dông "..tItemName[nType+6][1].."B¾t ®Çu"..tItemName[6][1].."Received"..tItemName[16][1].." and"..tItemName[17][1].." thÊt b¹i, kı hiÖu:"..nAddFlag);
				end				
			end
		else
...
function confirm_give_stone()
	...
	if DelItem(tItemName[9][2],tItemName[9][3],tItemName[9][4],6) == 1 and DelItem(tItemName[6][2],tItemName[6][3],tItemName[6][4],1) == 1 then
		...
		if nAddFlag == 1 then
			...
			WriteLog("[Ho¹t ®éng Kû niÖm 20 n¨m]: Ng­êi ch¬i "..GetName().." dïng 6 "..tItemName[9][1].."B¾t ®Çu"..tItemName[6][1].." received 1"..tItemName[5][1].." thÊt b¹i, kı hiÖu:"..nAddFlag);
		end
	end
end
...
function confirm_give_horse(nType)
	...
	if DelItem(tItemName[9][2],tItemName[9][3],tItemName[9][4],6) == 1 and DelItem(tItemName[6][2],tItemName[6][3],tItemName[6][4],1) == 1 then
		...
		if nAddFlag == 1 then
			...
			WriteLog("[Ho¹t ®éng Kû niÖm 20 n¨m]: Ng­êi ch¬i "..GetName().." dïng 6 "..tItemName[9][1].."B¾t ®Çu"..tItemName[6][1].."Received 1"..tItemName[nType][1].." thÊt b¹i, kı hiÖu:"..nAddFlag);
		end
	end	
end
...
function confirm_give_ring()
	...
	if DelItem(tItemName[9][2],tItemName[9][3],tItemName[9][4],10) == 1 and DelItem(tItemName[6][2],tItemName[6][3],tItemName[6][4],1) == 1 then	
		...
		if nAddFlag == 2 then
			...
			WriteLog("[Ho¹t ®éng Kû niÖm 20 n¨m]: Ng­êi ch¬i "..GetName().."Use 10"..tItemName[9][1].."B¾t ®Çu"..tItemName[6][1].."Received"..tItemName[16][1].." and"..tItemName[17][1].." thÊt b¹i, kı hiÖu:"..nAddFlag);
		end							
	end
end