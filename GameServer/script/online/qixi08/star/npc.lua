...
function aoyun_star_main()
	...
	if nDate < g_nQiXiBeginDate then
		Talk(1,"",g_szInfoHead.."Thêi gian ho¹t ®éng <color=yellow>"..nYear1.."year"..nMonth1.."NguyÖt"..nDay1.." to"..nYear2.."year"..nMonth2.."NguyÖt"..nDay2.."<color>, vÞ thiÕu hiÖp nµy ®Õn lóc nhí ghÐ l¹i xem.");
		return 0;
	end;
