...
PLANT_SMALL_TREE_LIMIT = 8;	--Ã¿ÌìÖÖÐ¡Ê÷µÄÊýÁ¿ÏÞÖÆ
PLANT_BIG_TREE_LIMIT = 8;	--Ã¿ÌìÖÖ´óÊ÷µÄÊýÁ¿ÏÞÖÆ
...
SMALLTREETYPE = {	--Ä£°åÃû£¬NPCÃû×Ö£¬¼ä¸ôÊ±¼ä£¬ËùÐèÂ¶Ë®
		{"C©y Gi¸ng sinh 2d","MÇm c©y Th¸i H­ nhá ",120,1},
		{"C©y Gi¸ng sinh 2c","MÇm c©y Th¸i H­ nhá ",120,1},
		{"C©y Gi¸ng sinh 2b","C©y Th¸i H­ nhá ",120,1},
		}
else
TREETYPE = {	--Ä£°åÃû£¬NPCÃû×Ö£¬¼ä¸ôÊ±¼ä£¬ËùÐèÂ¶Ë®
