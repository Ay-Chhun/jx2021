...
function Init_Flag()
	...
	local npcFlag
	--=================================ÈªÖÝ¸®±±==============================
	npcFlag = CreateNpc("Tiªu s­-®èi tho¹i","Banner",108,1576,2994)
	SetNpcScript(npcFlag,"\\script\\online\\Ôªµ©»î¶¯\\Æì×Ó.lua")
	npcFlag = CreateNpc("Tiªu s­-®èi tho¹i","Banner",108,1571,2982)
	SetNpcScript(npcFlag,"\\script\\online\\Ôªµ©»î¶¯\\Æì×Ó.lua")
	npcFlag = CreateNpc("Tiªu s­-®èi tho¹i","Banner",108,1564,2968)
	SetNpcScript(npcFlag,"\\script\\online\\Ôªµ©»î¶¯\\Æì×Ó.lua")
	npcFlag = CreateNpc("Tiªu s­-®èi tho¹i","Banner",108,1553,2965)
	SetNpcScript(npcFlag,"\\script\\online\\Ôªµ©»î¶¯\\Æì×Ó.lua")
	npcFlag = CreateNpc("Tiªu s­-®èi tho¹i","Banner",108,1543,2954)
	SetNpcScript(npcFlag,"\\script\\online\\Ôªµ©»î¶¯\\Æì×Ó.lua")
	--=================================ãê¾©¸®ÄÏ==============================
	npcFlag = CreateNpc("Tiªu s­-®èi tho¹i","Banner",201,1460,2808)
	SetNpcScript(npcFlag,"\\script\\online\\Ôªµ©»î¶¯\\Æì×Ó.lua")
	npcFlag = CreateNpc("Tiªu s­-®èi tho¹i","Banner",201,1455,2823)
	SetNpcScript(npcFlag,"\\script\\online\\Ôªµ©»î¶¯\\Æì×Ó.lua")
	npcFlag = CreateNpc("Tiªu s­-®èi tho¹i","Banner",201,1445,2831)
	SetNpcScript(npcFlag,"\\script\\online\\Ôªµ©»î¶¯\\Æì×Ó.lua")
	npcFlag = CreateNpc("Tiªu s­-®èi tho¹i","Banner",201,1437,2833)
	SetNpcScript(npcFlag,"\\script\\online\\Ôªµ©»î¶¯\\Æì×Ó.lua")
	npcFlag = CreateNpc("Tiªu s­-®èi tho¹i","Banner",201,1427,2830)
	SetNpcScript(npcFlag,"\\script\\online\\Ôªµ©»î¶¯\\Æì×Ó.lua")
	--=================================³É¶¼¸®ÄÏ==============================
	npcFlag = CreateNpc("Tiªu s­-®èi tho¹i","Banner",304,1396,2925)
	SetNpcScript(npcFlag,"\\script\\online\\Ôªµ©»î¶¯\\Æì×Ó.lua")
	npcFlag = CreateNpc("Tiªu s­-®èi tho¹i","Banner",304,1398,2940)
	SetNpcScript(npcFlag,"\\script\\online\\Ôªµ©»î¶¯\\Æì×Ó.lua")
	npcFlag = CreateNpc("Tiªu s­-®èi tho¹i","Banner",304,1402,2949)
	SetNpcScript(npcFlag,"\\script\\online\\Ôªµ©»î¶¯\\Æì×Ó.lua")
	npcFlag = CreateNpc("Tiªu s­-®èi tho¹i","Banner",304,1404,2931)
	SetNpcScript(npcFlag,"\\script\\online\\Ôªµ©»î¶¯\\Æì×Ó.lua")
	npcFlag = CreateNpc("Tiªu s­-®èi tho¹i","Banner",304,1407,2973)
	SetNpcScript(npcFlag,"\\script\\online\\Ôªµ©»î¶¯\\Æì×Ó.lua")
end
