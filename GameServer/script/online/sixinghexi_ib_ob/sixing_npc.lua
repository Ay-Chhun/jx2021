...
function get_present(nType)
	...
	if nType == 1 then
		...
		Msg2Global("Player"..szPlayerName.."At"..szMapName.."GÆp ®­îc Phóc ThÇn nhËn v« sè quµ, thËt khiÕn cho ng­êi kh¸c ph¶i ganh tş!")
	elseif nType == 2 then
		nRand = random(1,100)
		if nRand <= 75 then
			Earn(80000);
		...
		Msg2Global("Player"..szPlayerName.."At"..szMapName.."GÆp ThÇn tµi nhËn ®­îc v« sè ng©n l­îng"..szPresent..", thËt khiÕn ng­êi kh¸c ph¶i ganh tş!");
	elseif nType == 3 then
		nRand = random(1,100)
		if nRand <= 85 then
			AddItem(2,1,481,1);
		...
		Msg2Global("Player"..szPlayerName.."At"..szMapName.."GÆp ®­îc ChiÕn thÇn nhËn ®­îc v« sè vËt phÈm"..szPresent..", khiÕn ng­êi kh¸c ph¶i ®è kş!");
	elseif nType == 4 then
		nRand = random(1,100)
		if nRand <= 25 then
			AddItem(1,1,14,30);
		...
		Msg2Global("Player"..szPlayerName.."At"..szMapName.."GÆp ®­îc Thùc thÇn, nhËn ®­îc v« sè thùc phÈm"..szPresent..", khiÕn ng­êi kh¸c ph¶i ganh tş!");
	end;
