...
tEventCNHVGift =
{
	...
	[4] = {"Marrow-Cleansing Spirit Pellet",1,1,CNHV_EXT_POINT_TTLD},	-- Gi¶i n¨m
	[5] = {"Bång Lai Tiªn §¬n",1,1,CNHV_EXT_POINT_BLTD}, 	-- Gi¶i s¸u
	[6] = {"Three Purities Pill",1,1,CNHV_EXT_POINT_TTH}, 	-- Gi¶i b¶y
}


tBookList =
{
	[1]   = {"Vajra Demon-Subduing Sutra",0,107,1,1},
	[2]   = {"V« TrÇn MËt tÞch",0,107,5,1},
	[3]   = {"TiÒm Long MËt tÞch",0,107,3,1},
	[4]   = {"Thiªn La MËt tÞch",0,107,7,1},
	[5]   = {"Nh­ ý MËt tÞch",0,107,9,1},
	[6]   = {"Azure Sea Score",0,107,11,1},
	...
	[13] = {"Nether Ghost Record",0,107,25,1},
