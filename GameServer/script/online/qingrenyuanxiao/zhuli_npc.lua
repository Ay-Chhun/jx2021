...
function main()
	if CanAcceptTask(TASK_LOVESTORY4,2) == 1 then
		...
		Talk(5,"","Ta nghÜ r»ng chØ cã ta kh«ng ngñ ®­îc, kh«ng biÕt Chu LÖ c« n­¬ng cã ngñ ®­îc hay kh«ng?",
				...
				"Th× ra chµng còng yªu ta? Ch¶ tr¸ch tim ta còng xao ®éng, thiÕu hiÖp biÕt kh«ng mçi khi ta gÆp mÆt chµng, ta kh«ng biÕt nãi g×? Chµng thËt th«ng minh! Ta cßn ®ang nghÜ, nÕu chµng kh«ng thÝch ta th× lµm sao? Chµng cã vî råi th× lµm sao ®©y?",
				"Th× ra nµng còng yªu La MËt µ! Qu¸ dÔ! §Ó ta vÒ nãi l¹i víi La MËt!")
		local OldPlayerIndex = PlayerIndex 
		for i=1,2 do
			PlayerIndex = GetTeamMember(i)
			SetTask(TASK_LOVESTORY4,3)
			TaskTip("VÒ gÆp La MËt chuyÓn ®¹t t×nh ý cña Chu LÖ")
		end
	...
	elseif CanAcceptTask(TASK_LOVESTORY4,6) == 1 then
		Talk(5,"","Nghe nãi hai ng­êi muèn tù tö v× t×nh?",
				...
				"Xin có lÊy! Nh­ng nhí tr¶ cho ta nhÐ!",
