...
function OnUse(nItem)
	...
	local tAward = {
		{1, 10, "Copper Medal",     {0, 153, 1, 1}, 0},	
		{1, 20, "Iron Medal",     {0, 153, 2, 1}, 0},
	...
	if DelItemByIndex(nItem, 1) == 1 then
		gf_EventGiveRandAward(tAward, gf_SumRandBase(tAward), 1, "Advanced Medal Chest", "D­ìng thµnh trang bÞ");
	end
end