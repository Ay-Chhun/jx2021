		...
		if DelItem(2,2,62,10) == 1 and DelItem(0,200,21,1) == 1 and DelItem(2,9,1,10) == 1
			...
			if nBody == 1 then
				...
				elseif GetItemCount(2,1,208) >= 10 and GetTask(TASK_GOT_HAT) == 1 then
					...
					strPresent = " 1 Christmas gift box"
				end
			elseif nBody == 2 then
