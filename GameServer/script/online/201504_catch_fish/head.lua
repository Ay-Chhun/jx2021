...
g_tCatchFish = {
	tBombs={
		--name exp point item
		{"Small Firecracker", {2,1,30817}, 10000, 1, 
			{
				{1,85, "Tuna", {2,1,30818,1},0},
				{1,14, "Sea Shrimp", {2,1,30819,1},0},
				{1,1, "Sea Crab", {2,1,30820,1},0},
			},
		},
		{"Victory Fireworks",  {2,1,30809},30000, 2,
			{
				{1,50, "Tuna", {2,1,30818,1},0},
				{1,40, "Sea Shrimp", {2,1,30819,1},0},
				{1,10, "Sea Crab", {2,1,30820,1},0},
			},
		},
		...
		{"Glory Fireworks",  {2,1,30811}, 50000, 3,
			{
				{1,45, "Tuna", {2,1,30818,1},0},
				{1,40, "Sea Shrimp", {2,1,30819,1},0},
				{1,15, "Sea Crab", {2,1,30820,1},0},
			},
		},
	},
	tCombine = {
		tItem = {"Small Firecracker", 2,1,30817, 1},
		tRequite = {
			{"Fuse", 2,1,30806, 10},
			{"Launch Tube", 2,1,30807, 10},
			{"Explosive Powder", 2,1,30808, 10},
			{"Flint Stone", 2,1,30816, 10},
		},
	},
	tBoss = {
		--min,max,delta,num,template,name, time
		{1000, 30000, 500, 8, "HX_yecha", "Sea Yaksha", 5*60*18},
		{5000, 30000, 1000, 2, "HX_sheyao", "Deep Sea Snake Demon", 10*60*18},
		{20000, 30000, 2000, 1, "HX_guichengxiang", "Turtle Prime Minister", 20*60*18},
