...
tbSay_201207 = {
	...
	format("Combine %s/combining_flame_201207", WuCai_ShenHuoZhong[5]),
...
function combining_1_201207()
	...
	Say(Activity_Ds_Name..format("Any 5 %s + 1 %s (sold at the Imperial Pavilion) = 1 %s", HuoZhongName, WuCai_Shenshi[5], WuCai_ShenHuoZhong[5]),getn(tbSay),tbSay);
end
...
function combining_2_201207()
	...
	Say(Activity_Ds_Name..format("Any 9 %s + 30 gold = 1 %s", HuoZhongName, WuCai_ShenHuoZhong[5]),getn(tbSay),tbSay);
end
