...
function confirm_open(nType)
	if GetItemCount(2,0,1075) < 1 then
		...
		if DelItem(2,0,1079,1) == 1 and DelItem(2,0,1075,1) == 1 then
			...
			Msg2Player("Chóc mõng b¹n nhËn ®­îc "..tItemInfo[19][1].."300 tokens!");
			...
			if nRandOne <= nProbOne then --»ñµÃ¼«Æ·ÎïÆ·
				...
				if nRandThree <= 20 then
					...
					if nRetCode == 1 then
						...
						Msg2Global("Player"..GetName().."Më Hép Kim Bµi Vinh Dù nhËn ®­îc trang bÞ Hoµng §Õ"..tbHuangDiRing1[nRoute][nRandRing][1].."!");
						...
						WriteLog("[Lçi 08 Tam tiÕt liªn th«ng]:"..GetName().."Më Hép Kim Bµi Vinh Dù nhËn ®­îc trang bÞ Hoµng §Õ"..tbHuangDiRing1[nRoute][nRandRing][1].."Error on AddItem, nRetCode:"..nRetCode);
					end	
				elseif nRandThree <= 40 then
					...
					if nRetCode == 1 then
						...
						Msg2Global("Player"..GetName().."Më Hép Kim Bµi Vinh Dù nhËn ®­îc trang bÞ Hoµng §Õ"..tbHuangDiRing2[nRoute][nRandRing][1].."!");
						...
						WriteLog("[Lçi 08 Tam tiÕt liªn th«ng]:"..GetName().."Më Hép Kim Bµi Vinh Dù nhËn ®­îc trang bÞ Hoµng §Õ"..tbHuangDiRing2[nRoute][nRandRing][1].."Error on AddItem, nRetCode:"..nRetCode);
					end							
					...
					if nType ~= 3 then
						...
						if nRoute == 2 then
							...
							if nRetCode == 1 then
								...
								Msg2Global("Player"..GetName().."Më Hép Kim Bµi Vinh Dù nhËn ®­îc trang bÞ Hoµng §Õ"..tHuangDiWeapon[nRoute][nType][1].."!");
								WriteLog("[08 Tam tiÕt liªn th«ng]:"..GetName().."Më Hép Kim Bµi Vinh Dù nhËn ®­îc trang bÞ Hoµng §Õ"..tHuangDiWeapon[nRoute][nType][1]);
							else
								WriteLog("[Lçi 08 Tam tiÕt liªn th«ng]:"..GetName().."Më Hép Kim Bµi Vinh Dù nhËn ®­îc trang bÞ Hoµng §Õ"..tHuangDiWeapon[nRoute][nType][1].."Error on AddItem, nRetCode:"..nRetCode);
							end	
						else
							...
							if nRetCode == 1 then
								...
								Msg2Global("Player"..GetName().."Më Hép Kim Bµi Vinh Dù nhËn ®­îc trang bÞ Hoµng §Õ"..tHuangDiWeapon[nRoute][nRandwp][1].."!");
								WriteLog("[08 Tam tiÕt liªn th«ng]:"..GetName().."Më Hép Kim Bµi Vinh Dù nhËn ®­îc trang bÞ Hoµng §Õ"..tHuangDiWeapon[nRoute][nRandwp][1]);
							else
								WriteLog("[Lçi 08 Tam tiÕt liªn th«ng]:"..GetName().."Më Hép Kim Bµi Vinh Dù nhËn ®­îc trang bÞ Hoµng §Õ"..tHuangDiWeapon[nRoute][nRandwp][1].."Error on AddItem, nRetCode:"..nRetCode);
							end					
						end	
					else
						...
						if nRetCode == 1 then
							...
							Msg2Global("Player"..GetName().."Më Hép Kim Bµi Vinh Dù nhËn ®­îc 1 "..tItemInfo[25][1]);
				...
				elseif nRandTwo <= tBoxChangGui[4][2] then
					...
					if nRetCode == 1 then
						...
						Msg2Global("Player"..GetName().."Më Hép Kim Bµi Vinh Dù nhËn ®­îc 1 quyÓn "..tItemInfo[31][1]);
						SetTask(TASK_USE_JIN_BOX,GetTask(TASK_USE_JIN_BOX)+1);
						local nProbShow = format("%.4f",(200000/10000)*GetTask(TASK_USE_JIN_BOX)*BOX_PROB_INCREASE);
						Talk(1,"","§©y lµ lÇn thø "..GetTask(TASK_USE_JIN_BOX).." lÇn më Hép Kim Bµi Vinh Dù, tû lÖ nhËn ®­îc cùc phÈm (Hiªn Viªn chiÕn, Hiªn Viªn ®Êu, vò khÝ Hiªn Viªn, Viªm Hoµng ThiÕt Hån) t¨ng cao<color=yellow>"..nProbShow.." %<color>. Khi nhËn ®­îc cùc phÈm, sè lÇn tÝnh x¸c suÊt sÏ ®­îc tÝnh l¹i tõ ®Çu.");											
					else
					...
					if IB_VERSION == 1 then --Ãâ·ÑÇø
						...
						if nRetCode == 1 then
							...
							Msg2Global("Player"..GetName().."Më Hép Kim Bµi Vinh Dù nhËn ®­îc 1 "..tItemInfo[38][1]);
							SetTask(TASK_USE_JIN_BOX,GetTask(TASK_USE_JIN_BOX)+1);
							local nProbShow = format("%.4f",(200000/10000)*GetTask(TASK_USE_JIN_BOX)*BOX_PROB_INCREASE);
							Talk(1,"","§©y lµ lÇn thø "..GetTask(TASK_USE_JIN_BOX).." lÇn më Hép Kim Bµi Vinh Dù, tû lÖ nhËn ®­îc cùc phÈm (Hiªn Viªn chiÕn, Hiªn Viªn ®Êu, vò khÝ Hiªn Viªn, Viªm Hoµng ThiÕt Hån) t¨ng cao<color=yellow>"..nProbShow.." %<color>. Khi nhËn ®­îc cùc phÈm, sè lÇn tÝnh x¸c suÊt sÏ ®­îc tÝnh l¹i tõ ®Çu.");								
						else
						...
						if nRetCode == 1 then
							...
							Msg2Global("Player"..GetName().."Më Hép Kim Bµi Vinh Dù nhËn ®­îc 1 "..tItemInfo[39][1]);
							SetTask(TASK_USE_JIN_BOX,GetTask(TASK_USE_JIN_BOX)+1);
							local nProbShow = format("%.4f",(200000/10000)*GetTask(TASK_USE_JIN_BOX)*BOX_PROB_INCREASE);
							Talk(1,"","§©y lµ lÇn thø "..GetTask(TASK_USE_JIN_BOX).." lÇn më Hép Kim Bµi Vinh Dù, tû lÖ nhËn ®­îc cùc phÈm (Hiªn Viªn chiÕn, Hiªn Viªn ®Êu, vò khÝ Hiªn Viªn, Viªm Hoµng ThiÕt Hån) t¨ng cao<color=yellow>"..nProbShow.." %<color>. Khi nhËn ®­îc cùc phÈm, sè lÇn tÝnh x¸c suÊt sÏ ®­îc tÝnh l¹i tõ ®Çu.");								
						else
