	...
	if GetItemCount(2,0,1017) < 1 then
		...
		if DelItem(2,0,1026,1) == 1 and DelItem(2,0,1017,1) == 1 then
			...
			if nRandTwo <= tBoxAward[2][3][6] then
				...
				Msg2Global("Player"..GetName().."Më r­¬ng ®ång Giang S¬n nhËn ®­îc "..tBoxAward[2][3][1]..tBoxAward[2][3][5].."!");
			end
			...
			if nRandFour <= tBoxAward[2][5][2] then
				...
				if nRetCode == 1 then
					...
					Msg2Global("Player"..GetName().."Më r­¬ng ®ång Giang S¬n nhËn ®­îc trang bÞ Hoµng §Õ "..tbHuangDiRing1[nRoute][nRand][1].."!");
					WriteLog("[07 Tam tiÕt liªn th«ng]:"..GetName().."Më r­¬ng ®ång Giang S¬n nhËn ®­îc trang bÞ Hoµng §Õ "..tbHuangDiRing1[nRoute][nRand][1]);
				else
					WriteLog("[B¸o lçi Tam tiÕt liªn th«ng 07]:"..GetName().."Më r­¬ng ®ång Giang S¬n nhËn ®­îc trang bÞ Hoµng §Õ "..tbHuangDiRing1[nRoute][nRand][1].."Error on AddItem, nRetCode:"..nRetCode);
				end				
			end
		end
	end
