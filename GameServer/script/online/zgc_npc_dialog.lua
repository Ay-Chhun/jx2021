...
function Xmas_prize_get()
	...
	if prize_seq_1 == 1 then			--½Ì»áÊ¥µ®Ê÷
		...
		local Xmas_tree_prize_A = {
			...
			{{0,108,112,"Alluring Christmas Hat"},{0,108,141,"T©n Chİnh kÕt"},{0,109,112,"Alluring Christmas Top"},{0,109,187,"T©n Chİnh th­êng"},{0,110,76,"Alluring Women's Christmas Bottom"},{0,110,83,"T©n Chİnh quÇn"}},
			{{0,108,111,"Small Christmas Hat"},{0,108,142,"Primal Main Hairpin"},{0,109,111,"Charming Women's Christmas Top"},{0,109,188,"Nguyªn Chİnh th­êng"},{0,110,75,"Charming Women's Christmas"},{0,110,84,"Primal Main Skirt"}}	
			}
...
function cong_Xmas_tree_up()
	...
	if New_conf_tree_level == 4 then
		...
		if map_name ~= 0 then
			SendTongMessage("At"..map_name.."C©y Gi¸ng sinh cña quı bang ®· th¨ng lªn cÊp 4, cã thÓ nhËn phÇn th­ëng.")
		end
	else
