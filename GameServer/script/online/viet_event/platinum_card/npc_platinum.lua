...
--		"Ta muèn kÝch ho¹t LÖnh bµi B¹ch Kim (tèn "..PlatinumCard_GetPrice().." Xu VËt PhÈm)/activate_BKL",
--		"Xem thêi h¹n cßn l¹i cña thÎ B¹ch Kim LÖnh/get_info_BKL",
--		"Ta muèn kÝch ho¹t nhËn th­ëng C¸i ThÕ Anh Hµo (nhËn th­ëng theo ®¼ng cÊp)/#activate_account_BKL(1)",
--		"Ta muèn kÝch ho¹t nhËn th­ëng TuyÖt ThÕ Cao Nh©n/#activate_account_BKL(2)",
...
--		"Ta muèn nhËn th­ëng theo ®¼ng cÊp (®· kÝch ho¹t thµnh c«ng)/award_level_BKL",
		--"Ta muèn ®æi Tø Linh Bèi/award_golden_jewel",
--		"T¹i h¹ chØ ghÐ ngang!/dlgover",
	}
	if nType == 1 then	
		tinsert(tSay,"Ta muèn kÝch ho¹t nhËn th­ëng C¸i ThÕ Anh Hµo (nhËn th­ëng theo ®¼ng cÊp/#activate_account_BKL(1)")		
	elseif nType == 2 then
		tinsert(tSay,"Ta muèn kÝch ho¹t nhËn th­ëng TuyÖt ThÕ Cao Nh©n/#activate_account_BKL(2)")	
	elseif nType == 3 then	
		tinsert(tSay,"Ta muèn nhËn th­ëng theo ®¼ng cÊp (®· kÝch ho¹t thµnh c«ng)/LHL_menu_award")
		...
		tinsert(tSay,"NhËn vËt phÈm miÔn phÝ mçi ngµy (cÊp 88 trë lªn: 44 vµng + 2 th¸i dÞch hçn nguyªn c«ng))/get_platinum_day_freeAward_CTAH")
	elseif nType == 4 then	
...
function confirm_get_platinum_day_CTAH()
	...
	if nType ~= 1 then
		Talk(1, "", "<color=green>Chñ Phßng M¸y<color>: Tµi kho¶n cña c¸c h¹ kh«ng cã L«i Hæ LÖnh hoÆc ch­a kÝch ho¹t nhËn th­ëng.")
		return
	end
	local nType = CheckActivatedExt_BKL()
	if nType ~= 1 then
	...
	if nReceiveCount > 0 then
		Talk(1, "", "<color=green>Chñ Phßng M¸y<color>: C¸c h¹ ®· nhËn th­ëng h«m nay råi. Mai quay l¹i nhÐ.")
		return
	end
	...
	gf_AddItemEx2({2,0,1082, 2,1},"Th¸i DÞch Hçn Nguyªn C«ng §å", szBKLBLogHeader, szBKLBLogAction) 
...
function get_platinum_day_freeAward_CTAH()
	...
	Earn(440000)
	gf_AddItemEx2({2,0,1082, 2,1},"Th¸i DÞch Hçn Nguyªn C«ng §å", szBKLBLogHeader, szBKLBLogAction) 
	gf_WriteLogEx(szBKLBLogHeader, "®æi thµnh c«ng", 1, "MiÔn phÝ mçi ngµy CTAH thµnh c«ng")
...
function activate_BKL()
	...
	if nBKL_End - GetTask(TSK_BKLB_START) < 5270400 or CheckAccountExt_BKL() ~= 0 then
		Msg2Player("L«i Hæ LÖnh vÉn cßn ®ang hiÖu lùc. §¹i hiÖp kh«ng thÓ kÝch ho¹t thªm ®­îc n÷a.")
		Talk(1, "", "<color=green>Chñ Phßng M¸y<color>: L«i Hæ LÖnh vÉn cßn ®ang hiÖu lùc. §¹i hiÖp kh«ng thÓ kÝch ho¹t thªm ®­îc n÷a.")
		return
	end	
	
	if GetItemCount(2,1,30230) < nPlatinumPrice then
		Talk(1, "", "<color=green>Chñ Phßng M¸y<color>: Tµi kho¶n cña c¸c h¹ kh«ng ®ñ Xu VËt PhÈm ®Ó kÝch ho¹t L«i Hæ LÖnh")
		return
	end
	...
	if DelItem(2,1,30230,nPlatinumPrice) == 1 then
		if nCreateTime >= 1332370895 and GetTask(TSK_BKLB_COUNT) == 0 and CheckCharged_BKL() == 0 then
			...
			Msg2Player("KÝch ho¹t L«i Hæ LÖnh thµnh c«ng trë thµnh C¸i ThÕ Anh Hµo. Vui lßng kÝch ho¹t nhËn th­ëng C¸i ThÕ Anh Hµo.")
			Talk(1, "", "<color=green>Chñ Phßng M¸y<color>: KÝch ho¹t L«i Hæ LÖnh thµnh c«ng trë thµnh C¸i ThÕ Anh Hµo. Vui lßng kÝch ho¹t nhËn th­ëng C¸i ThÕ Anh Hµo.")
		else
			SetTask(TSK_BKLB_START, GetTime())
			SetTask(TSK_BKLB_ACTIVE,2)
			gf_SetExtPointByte(EXT_POINT_BKLB, BYTE_BKLB_TYPE, 2) 		
			WriteLogEx(szBKLBLogHeader, "kich hoat TTCN",1);
			Msg2Player("KÝch ho¹t L«i Hæ LÖnh thµnh c«ng trë thµnh TuyÖt ThÕ Cao Nh©n. Vui lßng kÝch ho¹t nhËn th­ëng TuyÖt ThÕ Cao Nh©n.")
			Talk(1, "", "<color=green>Chñ Phßng M¸y<color>: KÝch ho¹t L«i Hæ LÖnh thµnh c«ng trë thµnh TuyÖt ThÕ Cao Nh©n. Vui lßng kÝch ho¹t nhËn th­ëng TuyÖt ThÕ Cao Nh©n.")
		end
	end
	...
	gf_WriteLogEx(szBKLBLogHeader, "Tæng sè kÝch ho¹t")
end
...
function activate_account_BKL(nType)
	...
	if CheckActivatedExt_BKL() ~= 0 then	--CheckActivated_BKL() ~= 0 or 
		Talk(1, "", "<color=green>Chñ Phßng M¸y<color>: Tµi kho¶n cña c¸c h¹ ®· ®­îc kÝch ho¹t råi, kh«ng cÇn kÝch ho¹t n÷a!");
		return
	end
	
	if nType == 1 then
		if CheckAccountExt_BKL() ~= 1 then	--GetTask(TSK_BKLB_ACTIVE) ~= 1 and 
			Talk(1, "", "<color=green>Chñ Phßng M¸y<color>: Kh«ng ph¶i C¸i ThÕ Anh Hµo, kh«ng thÓ kÝch ho¹t.");
			return
		end
			...
			if nLevel == NEEDED_LEVEL then
					if nExp <= NEEDED_EXP then
						if gf_SetExtPointByte(EXT_POINT_BKLB, BYTE_BKLB_TYPE, 3) == 1 then
							...
							Earn(999999)
							gf_WriteLogEx(szBKLBLogHeader, "KÝch ho¹t thµnh c«ng C¸i ThÕ Anh Hµo",1, "C¸i ThÕ Anh Hµo")
							Talk(1, "", "<color=green>Chñ Phßng M¸y<color>: Tµi kho¶n cña c¸c h¹ ®· ®­îc kÝch ho¹t C¸i ThÕ Anh Hµo! Vui lßng ®¨ng nhËp l¹i!");	
						end	
					else
--						if gf_SetExtPointByte(EXT_POINT_BKLB, BYTE_BKLB_TYPE, 4) == 1 then
--							SetTask(TSK_BKLB_REWARD, 0)
--							SetTask(TSK_BKLB_EXCHANGE,0)
--							gf_WriteLogEx(szBKLBLogHeader, "KÝch ho¹t thµnh c«ng TuyÖt ThÕ Cao Nh©n",1, "TuyÖt ThÕ Cao Nh©n do level cao")
...
--						end	
						Talk(1, "", "<color=green>Chñ Phßng M¸y<color>: §Ó kÝch ho¹t C¸i ThÕ Anh Hµo cÇn ®¼ng cÊp <= 73 vµ ®iÓm kinh nghiÖm ph¶i Ýt h¬n 20 triÖu.")
						return 0
					end
...
--				SetTask(TSK_BKLB_REWARD, 0)
--				SetTask(TSK_BKLB_EXCHANGE,0)
--				gf_WriteLogEx(szBKLBLogHeader, "KÝch ho¹t thµnh c«ng TuyÖt ThÕ Cao Nh©n",1, "TuyÖt ThÕ Cao Nh©n")
--				Talk(1, "", "<color=green>Chñ Phßng M¸y<color>: Tµi kho¶n cña c¸c h¹ cã level qu¸ cao nªn kh«ng thÓ trë thµnh C¸i ThÕ Anh Hµo ®­îc. Chóc mõng ®¹i hiÖp ®· trë thµnh TuyÖt ThÕ Cao Nh©n. Vui lßng ®¨ng nhËp l¹i!");	
--			end	
			Talk(1, "", "<color=green>Chñ Phßng M¸y<color>: §Ó kÝch ho¹t C¸i ThÕ Anh Hµo cÇn ®¼ng cÊp <= 73 vµ ®iÓm kinh nghiÖm ph¶i Ýt h¬n 20 triÖu.")
			return 0
	...
	elseif nType == 2 then
		if CheckAccountExt_BKL() ~= 2 then		--GetTask(TSK_BKLB_ACTIVE) ~= 2 and 
			Talk(1, "", "<color=green>Chñ Phßng M¸y<color>: Kh«ng ph¶i TuyÖt ThÕ Cao Nh©n, kh«ng thÓ kÝch ho¹t.");
			return
		end
		if gf_SetExtPointByte(EXT_POINT_BKLB, BYTE_BKLB_TYPE, 4) == 1 then
			...
			SetTask(TSK_BKLB_EXCHANGE,0)
			gf_WriteLogEx(szBKLBLogHeader, "KÝch ho¹t thµnh c«ng TuyÖt ThÕ Cao Nh©n",1, "TuyÖt ThÕ Cao Nh©n")
			Talk(1, "", "<color=green>Chñ Phßng M¸y<color>: Tµi kho¶n cña c¸c h¹ ®· ®­îc kÝch ho¹t TuyÖt ThÕ Cao Nh©n! Vui lßng ®¨ng nhËp l¹i!");	
		end
	end
end
...
function get_BKL_award(nLevel)
	if CheckActivatedExt_BKL() ~= 1 then		--CheckActivated_BKL() ~= 1 and 
		Talk(1, "", "<color=green>Chñ Phßng M¸y<color>: Tµi kho¶n cña c¸c h¹ ch­a kÝch ho¹t nhËn th­ëng hoÆc kh«ng ph¶i C¸i ThÕ Anh Hµo!");
		return
	end
...
--		end
	...
	elseif nLevel == 80 then
		...
		Say("<color=green>Chñ Phßng M¸y<color>: Chóc mõng c¸c h¹ nhËn ®­îc phÇn th­ëng cÊp "..nLevel.."!",0)		
		--thªm kÝch ho¹t kinh m¹ch vâ gi¶
		gf_WriteLogEx(szLogTitle, "®æi thµnh c«ng", 1, "nhËn th­ëng theo cÊp "..nLevel)		
...
--		end
	...
	elseif nLevel == 87 then
		--GetTQVD()
		--gf_AddItemEx2({0,107,155,1}, "Ngò Hµnh MËt tÞch", szLogTitle, "nhËn ®­îc")
		gf_AddItemEx2({2,1,30408,3}, "Thiªn HuyÔn Kh¾c B¶n cÊp 3", szLogTitle, "nhËn ®­îc")
		gf_AddItemEx2({2,1,30491,7,1}, "VÐ TiÕu Y Vµng", szLogTitle, "nhËn ®­îc", 15*24*60*60)
		Say("<color=green>Chñ Phßng M¸y<color>: Chóc mõng c¸c h¹ nhËn ®­îc phÇn th­ëng cÊp "..nLevel.."!",0)		
		gf_WriteLogEx(szLogTitle, "®æi thµnh c«ng", 1, "nhËn th­ëng theo cÊp "..nLevel)		
...
--		gf_AddItemEx2(tb_golden_faction_tree[nRoute][13] , tb_golden_faction_tree[nRoute][12], szLogTitle, "nhËn ®­îc")
		gf_AddItemEx2({2,1,1067,1,1}, "§Þnh Hån Thiªn Th¹ch ThÇn Th¹ch", szLogTitle, "nhËn ®­îc", 15*24*60*60)
		Say("<color=green>Chñ Phßng M¸y<color>: Chóc mõng c¸c h¹ nhËn ®­îc phÇn th­ëng cÊp "..nLevel.."!",0)		
		gf_WriteLogEx(szLogTitle, "®æi thµnh c«ng", 1, "nhËn th­ëng theo cÊp "..nLevel)		
	...
	elseif nLevel == 90 then
		...
		Msg2Player("B¹n ®· bÞ trõ "..tb_golden_award_BKL[nLevel][5].." ®iÓm kinh nghiÖm.")
		ModifyReputation(- tb_golden_award_BKL[nLevel][6],0)
		Msg2Player("B¹n ®· bÞ trõ "..tb_golden_award_BKL[nLevel][6].." ®iÓm danh väng.")
		SetTask(336, GetTask(336) - tb_golden_award_BKL[nLevel][7])
		Msg2Player("B¹n ®· bÞ trõ "..tb_golden_award_BKL[nLevel][7].." ®iÓm s­ m«n.")		
		gf_AddItemEx2({2,1,1113,1,1}, "§¹i §Þnh Hån", szLogTitle, szLogAction, 30*24*60*60)	
