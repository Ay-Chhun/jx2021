...
tbVIET_0909_SJLD_AWARD = {
	{"Coiling Dragon Jade", 2500, {2, 1, 1000, 1}, 15 * 24 * 3600},
	{"M¶nh Thiªn th¹ch", 20000, {2, 2, 7, 1}, 0},
	{"Thiªn th¹ch", 20000, {2, 2, 8, 1}, 0},
	{"Ice Stone Fragment", 30000, {2, 1, 148, 1},  0},
	{"Ice Stone", 20000, {2, 1, 149, 1}, 0},
	{"Marrow-Cleansing Spirit Pill", 100, {2, 0, 137, 1}, 15 * 24 * 3600},
	{"§ång TiÒn Vµng", 1000, {2, 1, 30094, 1}, 0},
	{"Dew Water", 500000, {2, 0, 351, 1}, 0},
	{"Xiu Zhen Yao Jue", 26879, {2, 0, 554, 1}, 15 * 24 * 3600},
	{"Secret Manual Chest", 500, {2, 1, 30093, 1}, 30 * 24 * 3600},
	{"Essential Formula Chest_High Grade", 20, {2, 1, 30112, 1}, 30 * 24 * 3600},
	...
	{"Soul Duel", 2000, {2, 1, 1157, 1}, 15 * 24 * 3600},
	{"ThÇn N«ng §¬n", 5000, {2, 1, 343, 1}, 15 * 24 * 3600},
	{"Wenjin Box", 1000, {2, 1, 1100, 1}, 15 * 24 * 3600},
	{"Qu©n C«ng Ch­¬ng", 1000, {2, 1, 9999, 1}, 15 * 24 * 3600},
	{"Th¸i H­ §a MËt Qu¶ ", 10000, {2, 1, 387, 1}, 15 * 24 * 3600},
	{"Sect Volunteer Letter", 2500, {2, 1, 1019, 1}, 15 * 24 * 3600},
	...
	{"Paper Flower Tube", 253100, {2, 1, 30092, 1}, 0},
	{"Nh©n S©m V¹n N¨m", 1000, {2, 1, 30071, 1}, 0},
	{"B¶o R­¬ng §Æc BiÖt", 1, {2, 1, 30091, 1}, 30 * 24 * 3600},
	{"Town Sect Chest", 500, {2, 1, 30113, 1}, 30 * 24 * 3600},
};
...
tbVIET_0909_BAIBAOXIANG = {
	...
	{"Tribulation Dispelling Powder",2000,{2,0,141,1},15*24*3600},	
	{"TiÓu nh©n s©m qu¶",4000,{2,0,552,1},15*24*3600},	
	{"Coiling Dragon Jade",4000,{2,1,1000,1},15*24*3600},	
	{"NguyÖt Hoa",3800,{2,1,2002,1},0},	
	{"ThÕ th©n phï",2700,{2,0,556,1},15*24*3600},	
	{"MÆt n¹ s¸t thñ ®­êng",2700,{2,1,1087,1},15*24*3600},	
	{"Sword-Hiding Hero Card",2700,{2,0,31,1},15*24*3600},	
	{"S­ m«n lÖnh th­",2700,{2,1,1016,1},15*24*3600},	
	{"Spy Costume",2700,{2,1,9995,1},15*24*3600},	
	{"Th¸i h­ ®a mËt qu¶",2000,{2,1,387,1},15*24*3600},	
	{"Sect Volunteer Letter",2000,{2,1,1019,1},15*24*3600},	
	{"Qu©n c«ng ch­¬ng",2000,{2,1,9999,1},15*24*3600},	
	{"Refined Ice Stone",1300,{2,1,533,1},15*24*3600},	
	{"Great Ginseng",1300,{2,0,553,1},15*24*3600},	
	{"Qu©n c«ng bµi",1300,{2,1,997,1},15*24*3600},	
	{"Red Hare",1300,{0,105,9,1,1,-1,-1,-1,-1,-1,-1},30*24*3600},	
	{"Tr¶o hoµng phi ®iÖn",1300,{0,105,11,1,1,-1,-1,-1,-1,-1,-1},30*24*3600},	
	{"Marrow-Cleansing Pill",1100,{2,0,136,1},15*24*3600},	
	{"Mechanism Man",800,{2,1,1011,1},15*24*3600},	
	{"Silver Thunderbolt",800,{0,105,12,1,1,-1,-1,-1,-1,-1,-1},30*24*3600},	
	{"B¶o r­¬ng tµng kiÕm y gi¸p",800,{2,1,1060,1},15*24*3600},	
	{"Buchan",700,{0,105,13,1,1,-1,-1,-1,-1,-1,-1},30*24*3600},	
	{"Lôc l©m lang yªn",600,{2,1,1014,1},15*24*3600},	
	{"Thñy hoµng bÝ chiÕu",600,{2,1,1047,1},15*24*3600},	
	{"Mandarin Duck Gold Silver",600,{2,1,1048,1},15*24*3600},	
	{"Cöu ChuyÓn Håi Hån §¬n (x100)",500,{1,0,32,100},0},	
	{"B¶o r­¬ng tµng kiÕm hoa khè",500,{2,1,1061,1},15*24*3600},	
	{"Nation-Guarding Garment",400,{0,109,121,1},30*24*3600},	
	{"H¾c thiÕt y",400,{0,109,122,1},30*24*3600},	
	{"Purple Cloud Garment",400,{0,109,124,1},30*24*3600},	
	{"Cuiren Garment",400,{0,109,123,1},30*24*3600},	
	{"World Cup War Robe",400,{2,1,505,1},15*24*3600},	
	...
	{"Boundless Water",300,{2,1,503,1},15*24*3600},	
	...
	{"Secret Manual Chest",200,{2,1,30093,1},15*24*3600},	
	{"Marrow-Cleansing Spirit Pellet",100,{2,0,137,1},15*24*3600},	
	{"Pao Meteorite Stone",100,{2,1,1049,1},15*24*3600},	
	{"Nuwa Essence Stone",100,{2,1,504,1},15*24*3600},	
	{"Heshi Jade",100,{2,1,1001,1},15*24*3600},		
	{"ThÇn hµnh b¶o ®iÓn",50,{0,200,40,1},15*24*3600},	
	{"Huy hiÖu chiÕn c«ng (huy hoµng)",50,{2,1,9977,1},15*24*3600},	
	{"20 gold",20000,"Earn(%d)",200000},
	{"30 gold",10000,"Earn(%d)",300000},
	{"40 gold",5000,"Earn(%d)",400000},
	{"50 gold",4000,"Earn(%d)",500000},
	{"100 gold",3400,"Earn(%d)",1000000},
	{"5h ñy th¸c b¹ch c©u hoµn",18300,"SetTask(2501, GetTask(2501) + %d)", 5*60},
	{"5h ñy th¸c lôc thÇn hoµn",24400,"EatLiushen(1, %d)", 5*60},
	{"5h commission Shennong pill",7300,"SetTask(2502, GetTask(2502) + %d)", 5*60},
	{"10h ñy th¸c b¹ch c©u hoµn",9100,"SetTask(2501, GetTask(2501) + %d)",10* 60},
	{"10h ñy th¸ch Lôc thÇn hoµn",12200,"EatLiushen(1, %d)", 10*60},
	{"10h entrust than nong don",3700,"SetTask(2502, GetTask(2502) + %d)", 10*60},
	...
	{"Gold coin",30000,{2,1,30094,1},0},	
	{"20 reputation",40000,"ModifyReputation(%d,0)",20},	
	{"30 reputation",30000,"ModifyReputation(%d,0)",30},
	{"50 reputation",20000,"ModifyReputation(%d,0)",50},
	{"70 reputation",10000,"ModifyReputation(%d,0)",70},
	{"100 reputation",4000,"ModifyReputation(%d,0)",100},
...
tbVIET_0909_GAOJIYAOJUE = {
	...
	{"Thoi Thi Ta Khi secret manual", 7, {2, 6, 151, 1}},
	{"Huyen Co secret manual", 7, {2, 6, 167, 1}},
};

--ÕóÅÉÏä½Å±¾ÁÐ±í
tbVIET_0909_ZHENPAIXIANG = {
	{"Tendon-Changing Classic - upper", 2, {2, 1, 916, 1}},
	{"DÞch C©n Kinh-trung", 2, {2, 1, 917, 1}},
	{"Yi Jin Jing - lower", 2, {2, 1, 918, 1}},
	{"Nh­ Lai ThÇn Ch­ëng-th­îng", 2, {2, 1, 919, 1}},
	{"Nh­ Lai ThÇn Ch­ëng-trung", 2, {2, 1, 920, 1}},
	{"Nh­ Lai ThÇn Ch­ëng-h¹ ", 2, {2, 1, 921, 1}},
	{"Marrow-Cleansing Classic - upper", 2, {2, 1, 922, 1}},
	{"TÈy Tñy Kinh-trung", 2, {2, 1, 923, 1}},
	{"Xi Sui Jing - lower", 2, {2, 1, 924, 1}},
	...
	{"Eighteen Dragon-Subduing Palms - upper", 2, {2, 1, 934, 1}},
	{"Gi¸ng Long ThËp B¸t Ch­ëng-trung", 2, {2, 1, 935, 1}},
	{"Eighteen Dragon-Subduing Palms - lower", 2, {2, 1, 936, 1}},
	...
	{"Town Guard Flying Dragon Spear", 1, {0, 107, 176, 1}},
	{"Xuyªn V©n L¹c Hång MËt TÞch", 1, {0, 107, 177, 1}},
	{"U Minh Phong Ma Manual", 1, {0, 107, 178, 1}},
	{"Linh Co Huyen Ta Manual", 1, {0, 107, 179, 1}},
	{"Hundred Herbs Secret Manual", 1, {0, 107, 156, 1}},
	{"Ngò Hµnh MËt tÞch", 1, {0, 107, 155, 1}},
}

--ÎÃ×Ó°ü½±Àø£¬¸ÅÂÊ»ùÊýÎª100
tb_VIET_0909_WENZIBAO = {
	{"Heshi Jade", 3, {2, 1, 1001, 1}, 15 * 24 * 3600},
	{"Marrow-Cleansing Spirit Pill", 3, {2, 0, 137, 1}, 15 * 24 * 3600},
	{"Secret Manual Chest", 3, {2, 1, 30093, 1}, 30 * 24 * 3600},
	{"Essential Formula Chest_High Grade", 1, {2, 1, 30112, 1}, 30 * 24 * 3600},
	{"Town Sect Chest", 3, {2, 1, 30113, 1}, 30 * 24 * 3600},
	...
	{"Tribulation Dispel Powder", 57, {2, 0, 141, 1}, 15 * 24 * 3600},
};
...
tb_VIET_0909_YUTUXIANG = {
	...
	{"Ice Stone", 1400, {2, 1, 149, 1}, 0},
	{"Marrow-Cleansing Spirit Pill", 100, {2, 0, 137, 1}, 15 * 24 * 3600},
	{"Secret Manual Chest", 500, {2, 1, 30093, 1}, 30 * 24 * 3600},
	{"Sieu Quang", 100, {0, 105, 19, 1,1,-1,-1,-1,-1,-1,-1}, 30 * 24 * 3600},
	{"Nh©n S©m V¹n N¨m", 500, {2, 1, 30071, 1}, 0},
	{"Tribulation Dispel Powder", 2000, {2, 0, 141, 1}, 15 * 24 * 3600},
	{"Thiªn Th¹ch linh th¹ch", 10, {2, 1, 1068, 1}, 15 * 24 * 3600},	
	{"Town Sect Chest", 60, {2, 1, 30113, 1}, 30 * 24 * 3600},
...
--	{"B¶o R­¬ng §Æc BiÖt", 16, {2, 1, 30091, 1}, 30 * 24 * 3600},
	...
	{"Fried egg rice", 15137, {1, 1, 14, 1}, 0},
	{"Golden Flour Cake", 14000, {1, 1, 15, 1}, 0},
	{"Plum Blossom", 14000, {1, 1, 16, 1}, 0},
	{"Minh NguyÖt D¹", 14000, {1, 1, 17, 1}, 0},
	{"Magnolia Spring", 14000, {1, 1, 18, 1}, 0},
	{"Northwest Gaze", 14000, {1, 1, 19, 1}, 0},
};
...
function Viet0909_Give_ShangXian_Aword()
	...
	if nRepLevel ~= 0 then
		...
		WriteLog(GetName() .. "Received"..tbVIET_0909_SHANGXIAN_AWORD[nRepLevel][3] .. "  ®iÓm kinh nghiÖm")
		gf_AddItemEx({2, 1, 30106, tbVIET_0909_SHANGXIAN_AWARD2[nRepLevel]}, "Flour");
	...
	if nFacLevel ~= 0 then
		...
		WriteLog(GetName() .. "Received"..tbVIET_0909_SHANGXIAN_AWORD[nFacLevel][3] .. "  ®iÓm kinh nghiÖm")
		gf_AddItemEx({2, 1, 30106, tbVIET_0909_SHANGXIAN_AWARD2[nFacLevel]}, "Flour");
