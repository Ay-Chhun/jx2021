...
function main()
	...
	tinsert(tbSayDialog, "View guide/do_guide")
...
function do_vote_1()
	local tListTruyenTranh = {
			[1] = 
			{
				...
				"Duel - Dang Minh Trong/#confirm_do_vote(2,1)",	
				"The Trapped Hero - Du Thanh Vu/#confirm_do_vote(3,1)",	
				...
				"Renowned Detective - Nguyen Huu Vinh/#confirm_do_vote(11,1)",	
			},
			[2] =
			{
				"Duel - Dang Minh Trong/#confirm_do_vote(2,1)",	
...
function WinFlowerNumber()
	AskClientForNumber("VoteNum",1,999,"Number of Mooncakes!")
end
...
function VoteNum( nCount)
		...
		[1] = 
			{
				...
				"Duel - Dang Minh Trong",
				"The Trapped Hero - Du Thanh Vu",
				...
				"Renowned Detective - Nguyen Huu Vinh",
			},
		[2] = 
			{
	...
	if GetItemCount(2, 1, 30326)  < nCount  then 
		Msg2Player("Hµnh trang ®¹i hiÖp kh«ng ®ñ "..nCount.." Mooncakes!!")
		return
	end
...
--	
	...
	gf_WriteLogEx(szLogTitle, "Take part in the vote",nMark, tVoteName[nType][nNum])
