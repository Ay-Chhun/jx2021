...
g_szInfoHead = "<color=green>".."Professor".."<color>: "
...
g_tbItem = 
{
	...
	[3] = {"Life-Begetting Powder",			1,	0,	16,		30,		5,			-1,	},
	...
	[25] = {"Lion's Roar",			2,	6,	29,		1,		1200,		-1,	},
	...
	[32] = {"Drunken Butterfly",				2,	6,	78,		1,		1200,		-1,	},
	[33] = {"Drunken Fist",				2,	6,	79,		1,		1200,		-1,	},
	...
	[44] = {"Thoi Thi Ta Khi secret manual",			2,	6,	151,	1,		1200,		-1,	},
	[45] = {"BÝ kiÕp Thi LiÖt Ma C«ng",			2,	6,	154,	1,		1200,		-1,	},
	[46] = {"Tam Co secret manual",				2,	6,	168,	1,		1200,		-1,	},
	[47] = {"Huyen Co secret manual",				2,	6,	167,	1,		1200,		-1,	},
...
function main()
	if is_xmas_08_viet_open() == 0 then
		Say(g_szInfoHead.."Merry Christmas!", 0)
		return
	end
	...
	for i = 1, nTableSize do
		g_tbOption[i] = g_tbItem[i][6].." Lucky Gift Box".." = "..g_tbItem[i][5]..g_tbItem[i][1]..format("/#exchange_prize(%d)", i)
	end
...
function exchange_talk_5()
	local selTab = {
				...
				g_tbOption[25],
				g_tbOption[26],
				"View previous page/exchange_talk_4",
...
function exchange_talk_6()
	local selTab = {
				...
				g_tbOption[30],
				g_tbOption[31],
				"View previous page/exchange_talk_5",
...
function exchange_talk_7()
	local selTab = {
				...
				g_tbOption[35],
				g_tbOption[36],
				"View previous page/exchange_talk_6",
...
function exchange_talk_8()
	local selTab = {
				...
				g_tbOption[40],
				g_tbOption[41],
				"View previous page/exchange_talk_7",
...
function exchange_talk_9()
	local selTab = {
				...
				g_tbOption[45],
				g_tbOption[46],
				"View previous page/exchange_talk_8",
...
function exchange_talk_10()
	local selTab = {
				...
				g_tbOption[48],
				g_tbOption[49],
				"View previous page/exchange_talk_9",
				"End dialogue/no",
				}
	Say(g_szInfoHead.."Sö dông Hép Quµ May M¾n ®æi ®­îc nh÷ng phÇn quµ nh­ sau:",getn(selTab),selTab);
end
...
function add_item_ex(tItem)
	...
	if nRetCode == 1 then
		...
		WriteLogEx(g_szLogTitle, "Professor", nItemNum, szItemName, format("(%d,%d,%d)", G, D, P), GetTongName() )
	else
		WriteLogEx(g_szLogTitle, "Professor", "", "", "", "", "Thu ®­îc thÊt b¹i, ".."AddItem return value = "..nRetCode)
	end
end
