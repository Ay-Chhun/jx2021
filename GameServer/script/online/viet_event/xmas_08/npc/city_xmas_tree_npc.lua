	...
	if GetExtPoint(4) == 1 then
		if PayExtPoint(4,1) == 1 then
			if GetExtPoint(4) == 0 then		
				...
				if nRetCode == 1 then
					Say(g_szInfoHead.."RÊt tèt! Ng­êi ®· ®¹t cÊp 55 råi sao? §©y lµ phÇn quµ cña ng­¬i, h·y mau mau sö dông, kh«ng khÐo l¹i hÕt h¹n sö dông.",1,"Thank you, Christmas tree/no")
				end
			end
		end
	end
