...
function confirm_confirm(nLevel)
	...
	if SetEventBit(nLevel - 70) == 1 then
		...
		elseif nLevel == 75 then
			...
			WriteLogEx("Hoat dong thang 6","Crouching Tiger Hidden Dragon",1, "¸o S­ m«n cÊp 8x");
		...
		elseif nLevel == 79 then
			...
			WriteLogEx("Hoat dong thang 6","Crouching Tiger Hidden Dragon",1,"Trang Søc Th¸i H­");
		elseif nLevel == 81 then
			gf_AddItemEx(tb_wohucanglong_item_aword_81[nBody][2], tb_wohucanglong_item_aword_81[nBody][1]);
			WriteLogEx("Hoat dong thang 6","Crouching Tiger Hidden Dragon",1,"QuÇn Tµng KiÕm cÊp 8x");
		elseif nLevel == 82 then
			...
			if 0 < nItem and nItem <= 45 then
				...
				WriteLogEx("Hoat dong thang 6","Crouching Tiger Hidden Dragon",1,"QuyÓn MËt TÞch TrÊn Ph¸i");
		...
		elseif nLevel == 83 then
			...
			WriteLogEx("Hoat dong thang 6","Crouching Tiger Hidden Dragon",1,"Vò KhÝ Bé Phi Yªn");
		end
		gf_SetLogCaption("");	
	end
end
