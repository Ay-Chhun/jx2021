...
function SelectSay()	
	...
	if GetName() == "ZhuHaiKS" then
		tinsert(tbSayDialog, "ZhuHaiKS Test/GM001Func") 
		tinsert(tbSayDialog, "ZhuHaiKS GM2/GM001Func2") 
	end
		--»î¶¯¿¨
	--tbSayDialog,szSayHead = ac_AddSection(tbSayDialog, szSayHead);
...
function GM_TraoLoiHoTuongQuan(nItemLevel,nBody,nLieuTong)
	...
	LIB_Award.szLogTitle = "NHAN THUONG DUA TOP "
	LIB_Award.szLogAction = "nhËn"
	if nLieuTong >= 2 then
		LIB_Award:Award(tbLieuAwardSet[nBody])
	else
		LIB_Award:Award(tbTongAwardSet[nBody])
	end
end
...
function GM001Func2()
	if GetName() == "ZhuHaiKS" then
		...
		tinsert(tbSayDialog,"TONG Body1/#GM_TraoLoiHoTuongQuan(13,1,1)"	)
		tinsert(tbSayDialog,"TONG Body2/#GM_TraoLoiHoTuongQuan(13,2,1)"	)
		tinsert(tbSayDialog,"TONG Body3/#GM_TraoLoiHoTuongQuan(13,3,1)"	)
		tinsert(tbSayDialog,"TONG Body4/#GM_TraoLoiHoTuongQuan(13,4,1)"	)
		
		tinsert(tbSayDialog,"LIEU Body1/#GM_TraoLoiHoTuongQuan(13,1,2)"	)
		tinsert(tbSayDialog,"LIEU Body2/#GM_TraoLoiHoTuongQuan(13,2,2)"	)
		tinsert(tbSayDialog,"LIEU Body3/#GM_TraoLoiHoTuongQuan(13,3,2)"	)
...
function GM_AddExchange()
	AddItem(0,102,30232,1,1,-1,-1,-1,-1,-1,-1,-1,0)
end
