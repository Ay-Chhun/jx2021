...
function cs6_get_translife_cloth()
	...
	for i = 1, 3 do
		gf_AddItemEx2(t_translife_cloth_cs6[nType][nTypePS][nKieuHinh][i], " Free outfit set", "Ngoai trang chuyen sinh 6","nhËn", 120*24*3600, "NhËn trang bŞ miÔn phİ thµnh c«ng")
...
function cs7_get_translife_cloth()
	...
	local nKieuHinh = GetBody()
	for i = 1, 3 do
		gf_AddItemEx2(t_translife_cloth_cs6[nType][nTypePS][nKieuHinh][i], " Free outfit set", "Ngoai trang chuyen sinh 7","nhËn", 120*24*3600, "NhËn trang bŞ miÔn phİ thµnh c«ng")
	end
...
function cs8_get_translife_cloth()
	...
	local nKieuHinh = GetBody()
	for i = 1, 3 do
		gf_AddItemEx2(t_translife_cloth_cs6[nType][nTypePS][nKieuHinh][i], " Free outfit set", "Ngoai trang chuyen sinh 8","nhËn", 120*24*3600, "NhËn trang bŞ miÔn phİ thµnh c«ng")
	end
...
function cs9_get_translife_cloth()
	...
	local nKieuHinh = GetBody()
	for i = 1, 3 do
		gf_PSAddNewItem(t_translife_cloth_cs6[nType][nTypePS][nKieuHinh][i], " Free outfit set", "Ngoai trang chuyen sinh 9","nhËn", 120*24*3600, "NhËn trang bŞ miÔn phİ thµnh c«ng")
	end
