...
g_szLogTitle = "Ho¹t ®éng th¸ng 10 : ".."Phi Phi Maiden"						--´Ë´¦·ÖÎª2¶ÎÖ»ÊÇÎªÁË²»Ôö¼ÓÐÂµÄ·­Òë
g_szInfoHead = "<color=green>".."Phi Phi Maiden".."<color>: "
...
g_tbItem = 
{
	...
	[4] = {" Life-Giving Dispersal Powder (small)",		2,	1,		483,	1,		30,		1},
	...
	[9] = {" Fireworks Messenger",				2,	1,		203,	1,		30,		5},
	[10] = {" Lôc L©m Lang Yªn",			2,	1,		1014,	1,		30,		6},
	[11] = {" Thñy Hoµng BÝ ChiÕu",			2,	1,		1047,	1,		30,		6},
	[12] = {" Mandarin Duck Gold Silk Silver",			2,	1,		1048,	1,		30,		6},
	[13] = {" Zhanyi Manual",				0,	107,	66,		1,		-1,		8},
	...
	[27] = {" Bihai Manual",				0,	107,	11,		1,		-1,		500},
	...
	[34] = {" Youming Demon Record",			0,	107,	25,		1,		-1,		500},
...
function main()
	...
	for i = 1, nTableSize do
		g_tbOption[i] = g_tbItem[i][7].." Small Ruyi".." = "..g_tbItem[i][5]..g_tbItem[i][1]..format("/#exchange_prize(%d)", i)
	end
...
function add_item_ex(tItem)
	...
	if nRetCode == 1 then
		...
		WriteLogEx("Hoat Dong Thang 10","Phi Phi Maiden",tItem[5],tItem[1])		
	else
