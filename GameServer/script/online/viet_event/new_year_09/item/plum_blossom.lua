...
g_tbItem = 
{
	...
	[1] = {TYPE_ITEM,	2,			1,	"Vajra Demon-Subduing Sutra",			0,	107,	1,	-1,	},
	...
	[6] = {TYPE_ITEM,	2,			1,	"Azure Sea Score",				0,	107,	11,	-1,	},
	...
	[13] = {TYPE_ITEM,	2,			1,	"Nether Ghost Record",				0,	107,	25,	-1,	},
	[14] = {TYPE_ITEM,	2,			1,	"Linh CÊ MÀt tﬁch",				0,	107,	27,	-1,	},
	[15] = {TYPE_ITEM,	10,			1,	"B∏t B∂o T»y TÒy Ti™n ß¨n",			2,	0,	138,	7,	},
	[16] = {TYPE_ITEM,	50,			1,	"Marrow-Cleansing Spirit Pill",				2,	0,	137,	7,	},
	[17] = {TYPE_ITEM,	1000,		1,	"Zhanyi Manual",				0,	107,	66,	-1,	},
	...
	[22] = {TYPE_ITEM,	40000,		1,	"Ice Stone Fragment",				2,	1,	148,	-1,	},
	[23] = {TYPE_ITEM,	40000,		1,	"Ice Stone",					2,	1,	149,	-1,	},
	[24] = {TYPE_ITEM,	10000,		1,	"BÂng Lai Ti™n ThÒy",				2,	1,	1012,	-1,	},
	[25] = {TYPE_ITEM,	20000,		1,	"BÂng Lai LÈ ThÒy",				2,	1,	1052,	-1,	},
	[26] = {TYPE_ITEM,	10000,		1,	"Plum Character",					2,	1,	30054,	-1,	},
	[27] = {TYPE_ITEM,	10000,		1,	"Orchid Character",					2,	1,	30055,	-1,	},
	[28] = {TYPE_ITEM,	10000,		1,	"Chrysanthemum Character",					2,	1,	30057,	-1,	},
	[29] = {TYPE_ITEM,	10000,		1,	"Bamboo Character",					2,	1,	30056,	-1,	},
	[30] = {TYPE_ITEM,	10000,		1,	"Th’ Th©n phÔ",				2,	0,	556,	7,	},
	[31] = {TYPE_ITEM,	2000,		1,	"Th«n hµnh b› phÊ",				0,	200,	39,	7,	},
	[32] = {TYPE_ITEM,	20000,		1,	"Tribulation Dispel Powder",				2,	0,	141,	7,	},
	...
	[39] = {TYPE_ITEM,	20000,		1,	"Fearless Powder",				1,	0,		65,	-1,	},
	[40] = {TYPE_ITEM,	10000,		1,	"Th«n Gi∏p Æ¨n",				1,	0,		54,	-1,	},
	[41] = {TYPE_ITEM,	10000,		1,	"Th«n Tr∏o Æ¨n",				1,	0,		55,	-1,	},
	[42] = {TYPE_ITEM,	15000,		1,	"Seven Wonders Spirit Pill",				1,	0,		68,	-1,	},
	...
	[58] = {TYPE_ITEM,	1,			1,	"Drunken Fist",				2,	6,	79,		-1,	},
	...
	[65] = {TYPE_ITEM,	1,			1,	"Tam Co secret manual",				2,	6,	168,	-1,	},

	--		¿‡–Õ	   ∏≈¬   ˝÷µ	Ã· æ◊÷∑˚¥Æ 		√¸¡Ó◊÷∑˚¥Æ
	[66] = {TYPE_CMD,	50000,	3,	{"Æi”m danh v‰ng"},		"ModifyReputation(%d,0)"},
	[67] = {TYPE_CMD,	70000,	20,	"Æi”m tu luy÷n",		"ModifyPopur(%d)"},
	[68] = {TYPE_CMD,	79398,	100,"Sword Hoard Points",	"SetTask(1801, GetTask(1801)+%d)"},
}
