...
function exchange_exp()
	AskClientForNumber("give_exp_award",0,GetItemCount(Item_table1[1],Item_table1[2],Item_table1[3]),"Enter the amount to exchange","")
end
...
function exchange_tgl()
	AskClientForNumber("give_tgl_award",0,floor(GetItemCount(Item_table1[1],Item_table1[2],Item_table1[3]) / Item_cost),"Enter the amount to exchange","")
end
