...
tEventFactionGift =
{
	[1] = {"Trang bÞ m«n ph¸i S¬ cÊp", "Weapon, Helm, Lower Garment", 30, BIT_LEVEL_30, 2, 3},											-- Level 30
	[2] = {"Trang bÞ m«n ph¸i Trung cÊp", "Vò khÝ, Trang Søc", 50, BIT_LEVEL_50, 4, 3}, 										-- Level 50
	[3] = {"Trang bÞ Tµng KiÕm", "Helm, Lower Garment, Upper Garment, Accessory, and Weapon", 60, BIT_LEVEL_60, 8, 6}, 				-- Level 60	
}
