...
function OnUse()
	Say("<color=green>H­íng dÉn<color>: L¹i ®Õn ho¹t ®éng 1-5, cuéc thi tranh b¸ 1-5 l¹i ®­îc khai m¹c, b¹n chuÈn bŞ ch­a?",
		...
		"Receive Mahjong tiles?/get",
		"Bµi M¹t ch­îc cã thÓ ®æi phÇn th­ëng ®ã/prize",
		"What does the Royal Pavilion sell?/buy",
...
function prize()
	local tTemp = {"§¬n Tr­¬ng/prize_danzhang",
		"Ordinary Hand/prize_pihu",
		"Pure One Color (Tong)/prize_qingyise_tong",
		"Pure One Color (Tiao)/prize_qingyise_tiao",
		"Thanh NhÊt S¾c (V¹n)/prize_qingyise_wan",
		"Great Four Joys/prize_dasixi",
...
function prize_danzhang()
	local tTemp = {"Previous page/goback_to_prize","Leave/nothing"}
