...
CC_QUESTION_LIB = {
	...
	{"Thóy Yªn Vò Tiªn sö dông vò khÝ g×?", 							{"a Linh Chi", "b Zither", "c Brush", "d Flute"}, 									1},
	{"Thó nu«i cña Thóy Yªn Linh N÷ lµ g×?", 							{"A Squirrel", "b Fox", "c White Marten", "d Hedgehog"}, 							3},
	{"M«n ph¸i Thóy Yªn chiªu mé nh÷ng ®Ö tö nµo?", 						{"a Male disciples", "b Female disciples", "c Both male and female recruited"}, 								2},
	{"Thóy Yªn Linh N÷ sö dông vò khÝ g×?", 							{"a KiÕm", "b Flute", "c Linh Chi", "d §ao"},	 									2},
	{"M«n ph¸i Thóy Yªn n»m vÞ trÝ nµo trªn b¶n ®å?", 				{"a Northeast direction", "b Northwest direction", "c Southwest direction", "d Southeast direction"},				3},
	{"Thóy Yªn Vò Tiªn cã lo¹i tÝnh n¨ng vâ c«ng nµo hç trî ®éi ngò chiÕn ®Êu?", 	{"a Dream Serpent", "b Thiªn Háa DiÔm D­¬ng", "c Enchanting Flower", "d Spirit Cat Fortune"}, 				2},
	{"Vâ c«ng trÊn ph¸i cña Thóy Yªn Vò Tiªn lµ g×?", 					{"a §¹p V©n X¶o Bé", "b Butterfly Lament", "c Thu NguyÖt Phó", "d Loan Ph­îng Cöu Thiªn"}, 		4},
	{"S­ phô cña Thóy Yªn Vò Tiªn lµ ai?", 								{"a Zhu Ziwen", "b Hå Man Thµnh", "c He Hai", "d Chai Fengni"}, 				1},
	{"Vâ c«ng trÊn ph¸i cña Thóy Yªn Linh N÷ lµ g×?", 					{"a Falling Flower Art", "b Cöu VÜ Hoa Tiªn QuyÕt", "c Tiªn L« H­¬ng", "d Ngäc Long Xuyªn NguyÖt QuyÕt"}, 2},
	{"Thó nu«i cña Thóy Yªn Linh N÷ ¨n lo¹i l­¬ng thùc nµo d­íi ®©y sÏ kh«ng häc ®­îc kü n¨ng ®Æc thï?", {"a TriÒu Thiªn Tiªu", "b Cooling Herb", "c Thiªn H­¬ng Hoa", "d MËt Qu¶"}, 4},
	{"M«n ph¸i C«n L«n chiªu mé nh÷ng ®Ö tö nµo?", 							{"a Male disciples", "b Female disciples", "c Both male and female recruited"}, 								1},
	{"C«n L«n Thiªn S­ L­u Ph¸i sö dông vò khÝ g×?", 					{"a §ao", "b KiÕm", "c C«n", "d Flute"}, 										2},
	{"M«n ph¸i C«n L«n n»m vÞ trÝ nµo trªn b¶n ®å?", 				{"a Northeast direction", "b Northwest direction", "c Southwest direction", "d Southeast direction"}, 			2},
	{"Nh©n vËt cÇn ph¶i ë trong tr¹ng th¸i nµo míi cã thÓ ph¸t ®éng ®­îc vâ c«ng Thiªn L«i Phï?", {"a Wind Sacrifice", "b Cuång L«i Phï", "c B¹o L«i Phï", "d L«i TÕ"}, 			4},
	{"Nh©n vËt cÇn ph¶i ë trong tr¹ng th¸i nµo míi cã thÓ ph¸t ®éng ®­îc vâ c«ng B¨ng Phong QuyÕt?", {"a Hard Wind", "b L«i TÕ", "c Wind Sacrifice", "d Wind-Controlling Art"}, 					3},
	{"S­ phô cña C«n L«n Thiªn S­ L­u Ph¸i lµ ai?", 						{"a M· BÊt TiÒn", "b Chen Buwei", "c Qin Buzhi", "d Ye Ziqiu"}, 			3},
	...
	{"Ch­ëng m«n cña m«n ph¸i C«n L«n lµ ai?", 								{"a Mai Burong", "b Ye Ziqiu", "c Zhu Buhuo", "d M· BÊt TiÒn"}, 			3},
	{"M«n ph¸i C«n L«n lÊy g× lµm sø mÖnh?", 							{"a Dominate the Martial World", "b B¶o VÖ Quèc Gia", "c Subdue Demons and Banish Evil", "d Aid the Poor and Save the Destitute"}, 3},
...
CC_CARD_AWARD = {
	[2] = {
		...
		{4, 3000, 1, 1},
		{5, 3000, 200, 1},
		{1, 2000, "Star Silver Fragment", {2, 1, 30299, 3}, 0},
		...
		{1, 4000, "Money Pouch", {2, 1, 30367, 1}, 0},
		...
		{1, 1000, "Tribulation Dispel Powder", {2, 0, 141, 1}, 0},
		{1, 4890, "TiÓu B¹ch C©u hoµn", {2, 1, 30307, 1}, 0},
		{1, 4000, "Small Three Purity Ring", {2, 1, 30308, 1}, 0},
		...
		{1, 5000, "Cultivation Truth Fragment", {2, 1, 30315, 1}, 0},
		{1, 5000, "Th¸nh VËt S­ M«n", {2, 1, 30311, 1}, 0},
		{1, 5000, "Bronze Tieu Y Token", {2, 1, 30493, 1}, 30 * 24 * 3600},
	...
	[3] = {
		...
		{1, 800, "Silver Tieu Y Token", {2, 1, 30492, 1}, 30 * 24 * 3600},
		{1, 2000, "Bronze Tieu Y Token", {2, 1, 30493, 1}, 30 * 24 * 3600},
...
CC_BOX_AWARD = {
	...
	{1, 200, "Falling Flower Art", {2, 1, 30506, 2}, 0},
	{1, 100, "Spirit Cat Fortune", {2, 1, 30507, 2}, 0},
}
...
CC_COPY_AWARD = {
	...
	[1] = {
		[1] = {
			...
			{1, 10, "Falling Flower Art", {2, 1, 30506, 1}, 0},
		},	
		[2] = {
		...
		[4] = {
			...
			{1, 35, "Falling Flower Art", {2, 1, 30506, 1}, 0},
	...
	[2] = {
		...
		[5] = {
			...
			{1, 30, "Falling Flower Art", {2, 1, 30506, 1}, 0},
		},
		[6] = {
			{1, 70, "L«i TÕ", {2, 1, 30505, 1}, 0},
			{1, 30, "Falling Flower Art", {2, 1, 30506, 1}, 0},
		...
		[7] = {
			...
			{1, 50, "Falling Flower Art", {2, 1, 30506, 1}, 0},
			{1, 5, "Spirit Cat Fortune", {2, 1, 30507, 1}, 0},
		},
	},
	--ÁºÉ½
