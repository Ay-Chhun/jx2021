...
--»î¶¯Ê±¼ä
QIANHE_START_TIME = 2016100300;
QIANHE_END_TIME = 2016110100;

--»î¶¯¿ªÊ¼Ê¹ÓÃÁÙÊ±ÈÎÎñ±äÁ¿£¬ÔÙ´Î¿ªÆôÒª×¢ÒâÁË
QHT_TASK_GROUP =  TaskManager:Create(7, 14);
...
function qht_award_heibao( targetNpcIdx )
	...
	qht_itmedice_roll({0, 105, 30029, 1, 4, -1, -1, -1, -1, -1, -1}, QHT_THROWDICE_CBFILE, "qht_throwdice_callback", 100, 60, qht_get_teamsize(),targetNpcIdx);
...
function qht_award_huangbao( targetNpcIdx )
	...
	qht_itmedice_roll({0, 105, 30030, 1, 4, -1, -1, -1, -1, -1, -1}, QHT_THROWDICE_CBFILE, "qht_throwdice_callback", 100, 60, qht_get_teamsize(),targetNpcIdx);
