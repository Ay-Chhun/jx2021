...
function finishkill()
	if get_spring_festival_state() == 1 then
		...
		if (sMoban == "NghiÖt Hån" and sName == "L·nh H­¬ng L¨ng") or (sMoban == "S¬n TÆc §Çu Môc" and sName == "Northern Greenwood Alliance Leader") or (sMoban == "HuyÒn Vâ Th­ong" and sName == "Th­¬ng ThÇn Doanh Thiªn") then
