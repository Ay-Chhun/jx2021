...
{
	[1] = 	{
				[2] = {"Primordial Unity Monk", 24, 1},	
				[4] = {"Battle Monk", 24, 2},	
				[3] = {"Zen Cultivation Monk", 24, 3},	
				[6] = {"Guardian", 24, 4},	
				[8] = {"Feather Robe Envoy", 24, 5},	
				[9] = {"Sanskrit Chant Envoy", 24, 6},	
				[11] = {"Evil Purging Disciple", 24, 7},	
				[12] = {"Wicked Punishing Disciple", 24, 8},	
				[14] = {"Pass Entering Daoist", 24, 9},	
				[15] = {"S¬n D­¬ng ®¹o nh©n", 24, 10},	
				[17] = {"Lieutenant", 24, 11},	
				[18] = {"Commandant", 24, 12},	
				[20] = {"Th«i MÖnh T¶n Nh©n", 24, 13},	
				[21] = {"Thùc T©m T¶n Nh©n", 24, 14},
				[23] = {"Pass Entering Daoist", 24, 9},	
				[29] = {"Feather Robe Envoy", 24, 5},	
				[30] = {"Sanskrit Chant Envoy", 24, 6},					
			},
			
	[2] = 	{
				[2] = {"Damo Vajra", 25, 1},	
				[4] = {"La H¸n Hé Ph¸p", 25, 2},	
				[3] = {"Scripture Teaching Master", 25, 3},	
				[6] = {"BÝ ®éc thÝch kh¸ch", 25, 4},	
				[8] = {"Purple Bamboo Envoy", 25, 5},	
				[9] = {"H¶i NguyÖt sø", 25, 6},	
				[11] = {"Tø H¶i hiÖp", 25, 7},	
				[12] = {"Eight Bag Disciple", 25, 8},	
				[14] = {"Selfless Daoist", 25, 9},	
				...
				[23] = {"Selfless Daoist", 25, 9},		
				[29] = {"Purple Bamboo Envoy", 25, 5},	
	...
	[3] =	{		
				...
				[14] = {"Scripture Mastering Daoist", 26, 9},	
				[15] = {"Th¸i Êt T¶n Nh©n", 26, 10},	
				[17] = {"Long T­¬ng t­íng qu©n", 26, 11},	
				[18] = {"Hæ Dùc t­íng qu©n", 26, 12},	
				[20] = {"Netherworld Ghost Slayer", 26, 13},	
				[21] = {"Boundless Rakshasa", 26, 14},	
				[23] = {"Scripture Mastering Daoist", 26, 9},	
				[29] = {"B¹ch Liªn Tiªn Tö", 26, 5},	
				[30] = {"Ngäc VËn Tiªn Tö", 26, 6},									
			},
			
	[4] =	{
				[2] = {"Elder of the Bodhidharma Hall", 27, 1},	
				[4] = {"Elder of the Arhat Hall", 27, 2},	
				[3] = {"Elder of the Sutra Pavilion", 27, 3},	
				...
				[17] = {"Zhenjun General", 27, 11},	
				[18] = {"Zhenglu General", 27, 12},	
				[20] = {"Yama Ghost Slayer", 27, 13},	
				[21] = {"Solitary Poison Rakshasa", 27, 14},	
	...
	[5] = {
				...
				[8] = {"Golden Light Holy Maiden", 28, 5},	
				[9] = {"Thiªn ¢m th¸nh n÷", 28, 6},	
				[11] = {"ChÊp Ph¸p tr­ëng l·o", 28, 7},	
				[12] = {"Staff-Wielding Elder", 28, 8},	
				[14] = {"Th­îng Thanh ch©n nh©n", 28, 9},	
				[15] = {"Purple Empyrean Supreme Man", 28, 10},	
				[17] = {"TrÊn Qu©n nguyªn so¸i", 28, 11},	
				[18] = {"Chinh Lç nguyªn so¸i", 28, 12},	
				[20] = {"Yama Venerable", 28, 13},	
				[21] = {"Solitary Poison Venerable", 28, 14},	
				[23] = {"Th­îng Thanh ch©n nh©n", 28, 9},		
				[29] = {"Golden Light Holy Maiden", 28, 5},	
...
tb_translife_cloth = 
{
	[1] =	{
				[1] =	{
							{"Rebirth Manor", {0,108,514,1,1,3,389,1,102}},	
							{"Rebirth Manor", {0,109,514,1,1,4,111,1,102}},	
							{"Rebirth Manor", {0,110,514,1,1,1,306,1,102}},	
						},
				
				[2] = 	{
							{"Rebirth Manor", {0,108,514,1,1,4,389,2,102}},	
							{"Rebirth Manor", {0,109,514,1,1,5,111,2,102}},	
							{"Rebirth Manor", {0,110,514,1,1,2,306,2,102}},	
						},
				
				[3] = 	{
							{"Rebirth Manor", {0,108,514,1,1,5,389,3,102}},	
							{"Rebirth Manor", {0,109,514,1,1,6,111,3,102}},	
							{"Rebirth Manor", {0,110,514,1,1,3,306,3,102}},	
						},
				
				[4] = 	{
							{"Rebirth Manor", {0,108,514,1,1,6,389,4,102}},	
							{"Rebirth Manor", {0,109,514,1,1,7,111,4,102}},	
							{"Rebirth Manor", {0,110,514,1,1,4,306,4,102}},	
						},
				[5] = 	{
							{"Rebirth Manor", {0,108,514,1,1,6,389,3,329}},	
							{"Rebirth Manor", {0,109,514,1,1,5,342,3,329}},	
							{"Rebirth Manor", {0,110,514,1,1,6,306,3,329}},	
						},
			},
				
	[2] = {
				[1] =	{
							{"Rebirth Manor", {0,108,514,1,1,1,107,1,102}},	
							{"Rebirth Manor", {0,109,514,1,1,1,409,1,102}},	
							{"Rebirth Manor", {0,110,514,1,1,1,79,1,80,1,102}},
						},	
				
				[2] =	{
							{"Rebirth Manor", {0,108,514,1,1,2,107,2,102}},	
							{"Rebirth Manor", {0,109,514,1,1,2,409,2,102}},	
							{"Rebirth Manor", {0,110,514,1,1,2,79,2,80,2,102}},	
						},
				
				[3] =	{
							{"Rebirth Manor", {0,108,514,1,1,3,107,3,102}},	
							{"Rebirth Manor", {0,109,514,1,1,3,409,3,102}},	
							{"Rebirth Manor", {0,110,514,1,1,3,79,3,80,3,102}},	
						},
				
				[4] =	{
							{"Rebirth Manor", {0,108,514,1,1,4,107,4,102}},	
							{"Rebirth Manor", {0,109,514,1,1,4,409,4,102}},	
							{"Rebirth Manor", {0,110,514,1,1,4,79,4,80,4,102}},	
						},
				[5] =	{
							{"Rebirth Manor", {0,108,514,1,1,4,107,3,329}},	
							{"Rebirth Manor", {0,109,514,1,1,5,409,3,329}},	
							{"Rebirth Manor", {0,110,514,1,1,5,79,5,80,3,329}},	
						},
			},	

	[4] = 	{	
				[1] =	{			
							{"Rebirth Manor", {0,108,514,1,1,1,27,1,102}},	
							{"Rebirth Manor", {0,109,514,1,1,4,111,1,102}},	
							{"Rebirth Manor", {0,110,514,1,1,3,41,3,42,1,102}},	
						},
				
				[2] =	{
							{"Rebirth Manor", {0,108,514,1,1,2,27,2,102}},	
							{"Rebirth Manor", {0,109,514,1,1,5,111,2,102}},	
							{"Rebirth Manor", {0,110,514,1,1,4,41,4,42,2,102}},	
						},
				
				[3] =	{
							{"Rebirth Manor", {0,108,514,1,1,3,27,3,102}},	
							{"Rebirth Manor", {0,109,514,1,1,6,111,3,102}},	
							{"Rebirth Manor", {0,110,514,1,1,5,41,5,42,3,102}},	
						},
				
				[4] =	{
							{"Rebirth Manor", {0,108,514,1,1,4,27,4,102}},	
							{"Rebirth Manor", {0,109,514,1,1,7,111,4,102}},	
							{"Rebirth Manor", {0,110,514,1,1,6,41,6,42,4,102}},	
						},
				[5] =	{
							{"Rebirth Manor", {0,108,514,1,1,4,27,3,329}},	
							{"Rebirth Manor", {0,109,514,1,1,5,342,3,329}},	
							{"Rebirth Manor", {0,110,514,1,1,4,292,4,293,3,329}},	
						},
			},
				
	[3] = {
				[1] =	{
							{"Rebirth Manor", {0,108,514,1,1,5,50,1,102}},	
							{"Rebirth Manor", {0,109,514,1,1,4,111,1,102}},	
							{"Rebirth Manor", {0,110,514,1,1,1,306,1,102}},	
						},
				
				[2] =	{
							{"Rebirth Manor", {0,108,514,1,1,1,252,2,102}},	
							{"Rebirth Manor", {0,109,514,1,1,5,111,2,102}},	
							{"Rebirth Manor", {0,110,514,1,1,2,306,2,102}},	
						},
				
				[3] =	{
							{"Rebirth Manor", {0,108,514,1,1,6,50,3,102}},	
							{"Rebirth Manor", {0,109,514,1,1,6,111,3,102}},	
							{"Rebirth Manor", {0,110,514,1,1,3,306,3,102}},	
						},
				
				[4] =	{
							{"Rebirth Manor", {0,108,514,1,1,2,252,4,102}},	
							{"Rebirth Manor", {0,109,514,1,1,7,111,4,102}},	
							{"Rebirth Manor", {0,110,514,1,1,4,306,4,102}},	
						},
				[5] =	{
							{"Rebirth Manor", {0,108,514,1,1,2,252,3,329}},	
							{"Rebirth Manor", {0,109,514,1,1,5,342,3,329}},	
							{"Rebirth Manor", {0,110,514,1,1,6,306,3,329}},	
						},
			},
