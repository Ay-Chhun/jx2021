...
JQ_WG_FLAG_ITEM_PARAM = {
					...
					{"Greatest Hero", 200000, 2, 1, 1041, JQ_ITEM_LIMIT_TIME, 1},
...
JQ_YG_FLAG_ITEM_PARAM = {
					{"Dew Water", 10000000, 2, 0, 351, 0, 1},
					{"M¶nh Thiªn th¹ch", 2025000, 2, 2, 7, 0, 1},
					{"Thiªn th¹ch", 3000000, 2, 2, 8, 0, 1},
					{"Ice Stone Fragment", 2000000, 2, 1, 148, 0, 1},
					{"Ice Stone", 3000000, 2, 1, 149, 0, 1},
					{"Bång Lai Tiªn Thñy", 1500000, 2, 1, 1012, 0, 1},
					{"Bång Lai Lé Thñy", 2000000, 2, 1, 1052, 0, 1},
					{"Reputation", 5000000, 0, 0, 0, 0, 3},
					{"Reputation", 1000000, 0, 0, 0, 0, 5},
					{"Reputation", 1000000, 0, 0, 0, 0, 10},
					{"Reputation", 500000, 0, 0, 0, 0, 50},
					{"LuyÖn", 31000000, 0, 0, 0, 0, 20},
					{"Sword Storage Point", 34500000, 0, 0, 0, 0, 100},
					{"Tµng KiÕm anh hïng thiÕp", 500000, 2, 0, 31, JQ_ITEM_LIMIT_TIME, 1},
					{"ThÕ Th©n phï", 1553800, 2, 0, 556, JQ_ITEM_LIMIT_TIME, 1},
					{"Tribulation Dispel Powder", 1000000, 2, 0, 141, JQ_ITEM_LIMIT_TIME, 1},
					{"B¸t B¶o TÈy Tñy Tiªn §¬n", 375, 2, 0, 138, JQ_ITEM_LIMIT_TIME, 1},
					{"Marrow-Cleansing Spirit Pill", 750, 2, 0, 137, JQ_ITEM_LIMIT_TIME,1},
					{"Thiªn Hµ MËt tÞch", 75000, 0, 107, 64, 0, 1},
					{"Tö Hµ MËt tÞch", 75000, 0, 107, 65, 0, 1},
					{"Zhanyi Manual", 37500, 0, 107, 66, 0, 1},
					{"Lôc L©m Lang Yªn", 12500, 2, 1, 1014, JQ_ITEM_LIMIT_TIME, 1},
					{"Thñy Hoµng BÝ ChiÕu", 12500, 2, 1, 1047, JQ_ITEM_LIMIT_TIME, 1},
					{"Yuanyang Gold Silver Thread", 20000, 2, 1, 1048, JQ_ITEM_LIMIT_TIME, 1},
					{"Messenger Fireworks", 50000, 2, 1, 203, JQ_ITEM_LIMIT_TIME, 1},
					...
					{"Greatest Hero", 5000, 2, 1, 1041, JQ_ITEM_LIMIT_TIME, 1},
					...
					{"Vajra Demon-Subduing Sutra", 3970, 0, 107, 1, 0, 1},
					...
					{"Azure Sea Score", 3970, 0, 107, 11, 0, 1},
					...
					{"Nether Ghost Record", 3970, 0, 107, 25, 0, 1},
