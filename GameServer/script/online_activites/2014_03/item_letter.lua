...
function OnUse(nItem)
	...
	tempSay.sel = {
		...
		{"Farmer Pill *1"..format("(tiªu hao %d )", 10), "#do_exchange_letter(3)"},
		{"Tribulation Dispersing Pill *1"..format("(tiªu hao %d )", 9), "#do_exchange_letter(4)"},
		...
		{"gold medic ticket*1"..format("(tiªu hao %d )", 2000), "#do_exchange_letter(7)"},
		{"silver medic ticket*1"..format("(tiªu hao %d )", 250), "#do_exchange_letter(8)"},
		{"copper medic ticket*1"..format("(tiªu hao %d )", 30), "#do_exchange_letter(9)"},
		...
		{"meteorite spirit stone*1"..format("(tiªu hao %d )", 5900), "#do_exchange_letter(13)"},
...
function do_exchange_letter(nIndex)
	local tAward = {
		...
		[4] = {1, 9, "Tribulation Dispel Powder", {2, 0, 141, 1}, 7 * 24 * 3600},
		...
		[8] = {1, 250, "Silver Tieu Y Token", {2, 1, 30492, 1}, 7 * 24 * 3600},
		[9] = {1, 30, "Bronze Tieu Y Token", {2, 1, 30493, 1}, 7 * 24 * 3600},
		...
		[17] = {1, 3900, "Reincarnation Pill", {2, 1, 30345, 1}, 60 * 24 * 3600},
