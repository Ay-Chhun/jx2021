...
function OnUse(nItem)
	...
	local tAwart = {
		{1, 10, "Treasure Chest", {2, 1, 30341, 1}, 0},
		...
		{1, 10, "Spirit Beast Egg - High", {2, 1, 30728, 1}, 0},
		{1, 10, "N÷ Oa Tinh Th¹ch", {2, 1, 504, 1}, 7 * 24 * 3600},
		{1, 10, "Reincarnation Pill", {2, 1, 30345, 1}, 15 * 24 * 3600},
		{2, 10, 999999999, 1},
		{32, 10, 99999, 1},
	}
	gf_EventGiveRandAward(tAwart, gf_SumRandBase(tAwart), 1, "Treasure Chest", "Treasure Chest")
end