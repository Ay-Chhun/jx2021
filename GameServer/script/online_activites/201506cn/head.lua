	...
	tMainAward = {
		[1] = {
			tAll = {
    			...
    			{1,"Western Region Tribute",{2,1,30871,50},0},
			},
			tRand = {
                { 1, 800, "Western Region Incense", {2,1,30874, 2}, 0, },
                ...
                { 1, 100, "Xiu Zhen Yao Jue", {2,0,554, 1}, 0, },
                ...
                { 1, 600, "Life-Begetting Powder", {1,0,16, 3}, 0, },
                { 1, 600, "V¹n VËt Quy Nguyªn §¬n", {1,0,11, 3}, 0, },
                { 1, 600, "Tribulation Dispel Powder", {2,0,141, 1}, 0, },
        	},
		},
		[2] = {
			nMaxCnt = 100,
			...
			tRand = {
                ...
                {2, 600, 2000000},--exp
                {2, 400, 4000000},--exp
                { 1, 300, "Bronze Tieu Y Token", {2,1,30493, 1, 4}, 0, },
                ...
                { 1, 1500, "Life-Begetting Powder", {1,0,16, 1, 4}, 0, },
                { 1, 1500, "V¹n VËt Quy Nguyªn §¬n", {1,0,11, 1, 4}, 0, },
                { 1, 100, "Ice Stone", {2,1,149, 1, 4}, 0, },
                { 1, 1, "Thiªn Kiªu LÖnh", {2,97,236, 1, 4}, 0, },
                { 1, 100, "Tribulation Dispel Powder", {2,0,141, 1, 4}, 0, },
			},
		},
		[3] = {
			nMaxCnt = 1000,
			...
			tRand = {
                ...
                { 1, 600, "Life-Begetting Powder", {1,0,16, 3}, 0, },
                { 1, 600, "V¹n VËt Quy Nguyªn §¬n", {1,0,11, 3}, 0, },
                { 1, 100, "Tribulation Dispel Powder", {2,0,141, 1}, 0, },
                { 1, 50, "Ice Stone", {2,1,149, 1}, 0, },
                { 1, 50, "Xiu Zhen Yao Jue", {2,0,554, 1}, 0, },
