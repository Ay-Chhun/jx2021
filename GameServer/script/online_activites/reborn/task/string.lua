...
VET_200912_STR_XIAXIANTISHI = {
    {"§· chuyÓn sinh thµnh c«ng vµ gia nhËp %s, sau khi tho¸t ra ®¨ng nhËp l¹i míi cã hiÖu lùc, <color=red> (Chó ı: sau khi rêi m¹ng xong sÏ trë vÒ cÊp 10, giíi h¹n trªn hµnh trang chØ ®­îc mang 1000000 ®ång.)<color>","Ta muèn ®¨ng nhËp l¹i/VET_201003_REBOOT_CLIENT","Let me go deposit my money first/gf_DoNothing"},
}
