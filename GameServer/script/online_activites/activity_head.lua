...
function ahf_GetPetBook(nLv)
	...
	local T_Pet_Book = {
			{1, 6, format("Level %d Vital Qi Body Guard", nLevel), {2, 150,	1 +nLevel-1, 1}, 0},
			{1, 6, format("CÊp %d Ých Thä Diªn D­¬ng", nLevel), {2, 150,	5 +nLevel-1, 1}, 0},
			{1, 6, format("Level %d Strong Body Mighty Form", nLevel), {2, 150,	9 +nLevel-1, 1}, 0},
			{1, 6, format("Level %d Yin Wind Bone Eroding", nLevel), {2, 150,	13+nLevel-1, 1}, 0},
			{1, 6, format("CÊp %d HuyÒn Vò V« Song", nLevel), {2, 150,	17+nLevel-1, 1}, 0},
			{1, 7, format("Level %d Five Elements Formless", nLevel), {2, 150,	21+nLevel-1, 1}, 0},
			{1, 7, format(" Level %d Gold Spirit Body Aid", nLevel), {2, 150,	25+nLevel-1, 1}, 0},
			{1, 7, format("Level %d Wood Spirit Body Aid", nLevel), {2, 150,	29+nLevel-1, 1}, 0},
			...
			{1, 7, format("Level %d Earth Spirit Body Aid", nLevel), {2, 150,	41+nLevel-1, 1}, 0},
			{1, 7, format("Level %d Void Shadow Slash", nLevel), {2, 150,	45+nLevel-1, 1}, 0},
			{1, 7, format("Level %d Deepened Damage", nLevel), {2, 150,	49+nLevel-1, 1}, 0},
			{1, 7, format("Level %d Nimble Spirit Swiftness", nLevel), {2, 150,	53+nLevel-1, 1}, 0},
			{1, 7, format("Level %d Formless Ancient", nLevel), {2, 150,	57+nLevel-1, 1}, 0}, 
	}
...
function ahf_Get70GaojiMiji(bIsByRoute, nNum, bIsBand)
	...
	local tBook = {
		[2] =  {0, 107, 166, "Kim Cang Bat Nha Kinh"},
		[4] =  {0, 107, 167, "TiÒm Long TÞch DiÖt Kinh"},
		[3] =  {0, 107, 168, "Vo Tran Bo De Kinh"},
		[6] =  {0, 107, 169, "Thiªn La Liªn Ch©u Lôc"},
		[8] =  {0, 107, 170, "Nh­ ý Kim §Ønh MËt TÞch"},
		[9] =  {0, 107, 171, "Azure Sea Silent Sound Score"},
		...
		[17] = {0, 107, 176, "Tran Quan Phi Long Thuong Manual"},
		[18] = {0, 107, 177, "Xuyªn V©n L¹c Hång MËt TÞch"},
		[20] = {0, 107, 178, "U Minh Phong Ma Manual"},
		[21] = {0, 107, 179, "Linh Co Huyen Ta Manual"},
...
function ahf_GiveShimenCloth9()
	...
	local VET_FACTION_CLOTH_9 = {
		{1, 20, "Boundless Asura Blood-Drenched Robe", {0, 100, 2131, 1, 1, -1, -1, -1, -1, -1, -1}},
		{1, 20, "Boundless Asura Blood-Drenched Robe", {0, 100, 2132, 1, 1, -1, -1, -1, -1, -1, -1}},
		{1, 20, "Boundless Asura Blood-Drenched Robe", {0, 100, 2133, 1, 1, -1, -1, -1, -1, -1, -1}},
		{1, 20, "Boundless Asura Blood-Drenched Robe", {0, 100, 2134, 1, 1, -1, -1, -1, -1, -1, -1}},
...
AH_GG_BOOK1 = {
	[2] = {0, 107, 204, "Vajra Prajna True Manual"},
	[3] = {0, 107, 206, "Dustless Bodhi True Manual"},
	[4] = {0, 107, 205, "Hidden Dragon Annihilation True Manual"},
	[6] = {0, 107, 207, "Thiªn La Liªn Ch©u Ch©n QuyÓn"},
	[8] = {0, 107, 208, "Wishful Golden Top True Manual"},
	...
	[15] = {0, 107, 213, "Gentleman Welcomes the Wind True Manual"},
...
function ahf_GetLevel3JSEquip()
	local tAward = {
		...
		{1, 7, "Gao Tong Wa Recipe", {0, 154, 3, 1}, 0},
	...
	gf_EventGiveRandAward(tAward, gf_SumRandBase(tAward), 1, "ACTIVITY_HEAD", "Golden Snake equipment 3 stars")
end
...
function ahf_GiveYunLingLevel5()
	local szMsgTitle = "Yun Ling Level 5"
...
function ahf_GiveYunLingLevel6()
	local szMsgTitle = "Yun Ling Level 6"
	--tPara = {nCount, nBind, nExpireDays, bGblMsg}
	local tbParamData = {1, 4, 7, nil}
