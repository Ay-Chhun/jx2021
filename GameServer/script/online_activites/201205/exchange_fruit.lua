...
VET_201205_TMC_AWARD1 = {
    {1, 5, "Longan", {2, 1, 30164, 1}, 0},
    {1, 5, "Rambutan", {2, 1, 30165, 1}, 0},
    {1, 15, "Cam", {2, 1, 30165, 1}, 0},
    {1, 5, "Coconut", {2, 1, 30167, 1}, 0},
    {1, 5, "Mangosteen", {2, 1, 30168, 1}, 0},
    {1, 5, "Soursop", {2, 1, 30179, 1}, 0},
    {1, 15, "Pineapple", {2, 1, 30180, 1}, 0},
    {1, 15, "Li", {2, 1, 30181, 1}, 0},
    {1, 15, "Langsat", {2, 1, 30182, 1}, 0},
    {1, 15, "Star Fruit", {2, 1, 30183, 1}, 0},
};

 
VET_201205_TMC_AWARD2 = {
    {1, 5, "Pomelo", {2, 1, 30169, 1}, 0},
    {1, 10, "Strawberry", {2, 1, 30170, 1}, 0},
    {1, 15, "Banana", {2, 1, 30171, 1}, 0},
    {1, 5, "Mango", {2, 1, 30172, 1}, 0},
    {1, 5, "Peach", {2, 1, 30173, 1}, 0},
    {1, 10, "Plum", {2, 1, 30174, 1}, 0},
    {1, 15, "Lychee", {2, 1, 30175, 1}, 0},
    {1, 15, "Apple", {2, 1, 30176, 1}, 0},
    {1, 15, "Avocado", {2, 1, 30177, 1}, 0},
    {1, 5, "Papaya", {2, 1, 30178, 1}, 0},
};
