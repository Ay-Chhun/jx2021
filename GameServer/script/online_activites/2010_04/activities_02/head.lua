...
function VET_201004_02_GivePlantSmallTreeAward()
    ...
    if gf_CheckEventDateEx(5) == 1 then
        gf_AddItemEx2({2, 1, 30184, 50}, "Material Pouch","Hoat dong thang 4 nam 2010","PhÇn th­ëng trång c©y b¸t nh· nhá");
    end
    --±¾»î¶¯Ã»ÓÐÊ±¼äÏÞÖÆ
...
function VET_201004_02_GivePlantBigTreeAward()
	do return end
    if gf_CheckEventDateEx(5) == 1 then
        gf_AddItemEx2({2, 1, 30184, 50}, "Material Pouch","Hoat dong thang 4 nam 2010","PhÇn th­ëng trång c©y b¸t nh· lín");
    end
    --±¾»î¶¯Ã»ÓÐÊ±¼äÏÞÖÆ
