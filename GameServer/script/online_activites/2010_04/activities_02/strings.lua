...
VET_201004_02_TB_RAND_AWARD_LIST = {
    [1] = {1, 5, "Longan"  , {2, 1, 30164, 1}, 0, 0},
    [2] = {1, 5, "Rambutan", {2, 1, 30165, 1}, 0, 0},
    [3] = {1, 5, "Cam",   {2, 1, 30166, 1}, 0, 0},
    [4] = {1, 5, "Coconut",   {2, 1, 30167, 1}, 0, 0},
    [5] = {1, 5, "Mangosteen",   {2, 1, 30168, 1}, 0, 0},
    [6] = {1, 5, "Pomelo",   {2, 1, 30169, 1}, 0, 0},
    [7] = {1, 5, "Strawberry",   {2, 1, 30170, 1}, 0, 0},
    [8] = {1, 5, "Banana",   {2, 1, 30171, 1}, 0, 0},
    [9] = {1, 5, "Mango",   {2, 1, 30172, 1}, 0, 0},
    [10]= {1, 5, "Peach",   {2, 1, 30173, 1}, 0, 0},
    [11]= {1, 5, "Plum",   {2, 1, 30174, 1}, 0, 0},
    [12]= {1, 5, "Lychee",   {2, 1, 30175, 1}, 0, 0},
    [13]= {1, 5, "Apple",   {2, 1, 30176, 1}, 0, 0},
    [14]= {1, 5, "Avocado",   {2, 1, 30177, 1}, 0, 0},
    [15]= {1, 5, "Papaya",   {2, 1, 30178, 1}, 0, 0},
    [16]= {1, 5, "Soursop", {2, 1, 30179, 1}, 0, 0},
    [17]= {1, 5, "Pineapple",   {2, 1, 30180, 1}, 0, 0},
    [18]= {1, 5, "Li",   {2, 1, 30181, 1}, 0, 0},
    [19]= {1, 5, "Langsat",   {2, 1, 30182, 1}, 0, 0},
    [20]= {1, 5, "Star Fruit",   {2, 1, 30183, 1}, 0, 0},
};

VET_201004_02_TB_SMALLTREE_RAND_AWARD_LIST = {
    [1] = {1, 45, "Longan", {2, 1, 30164, 2}, 0, 0},
    [2] = {1, 45, "Apple", {2, 1, 30176, 2}, 0, 0},
    [3] = {1, 10, "Plum", {2, 1, 30174, 2}, 0, 0},
};

VET_201004_02_TB_BIGTREE_RAND_AWARD_LIST = {
    [1] = {1, 30, "Longan", {2, 1, 30164, 2}, 0, 0},
    [2] = {1, 30, "Apple", {2, 1, 30176, 2}, 0, 0},
    [3] = {1, 30, "Plum", {2, 1, 30174, 2}, 0, 0},
    [4] = {1, 4 , "Banana", {2, 1, 30171, 2}, 0, 0},
    [5] = {1, 4 , "Peach", {2, 1, 30173, 2}, 0, 0},
    [6] = {1, 1 , "Papaya", {2, 1, 30178, 2}, 0, 0},
    [7] = {1, 1 , "Langsat", {2, 1, 30182, 2}, 0, 0},
};

VET_201004_02_TB_ITEM_LIST = {
    [1] = {"Longan"  , 2, 1, 30164},
    [2] = {"Rambutan", 2, 1, 30165},
    [3] = {"Cam",   2, 1, 30166},
    [4] = {"Coconut",   2, 1, 30167},
    [5] = {"Mangosteen",   2, 1, 30168},
    [6] = {"Pomelo",   2, 1, 30169},
    [7] = {"Strawberry",   2, 1, 30170},
    [8] = {"Banana",   2, 1, 30171},
    [9] = {"Mango",   2, 1, 30172},
    [10]= {"Peach",   2, 1, 30173},
    [11]= {"Plum",   2, 1, 30174},
    [12]= {"Lychee",   2, 1, 30175},
    [13]= {"Apple",   2, 1, 30176},
    [14]= {"Avocado",   2, 1, 30177},
    [15]= {"Papaya",   2, 1, 30178},
    [16]= {"Soursop", 2, 1, 30179},
    [17]= {"Pineapple",   2, 1, 30180},
    [18]= {"Li",   2, 1, 30181},
    [19]= {"Langsat",   2, 1, 30182},
    [20]= {"Star Fruit",   2, 1, 30183},
};
...
VET_201004_02_TB_STRINGS = {
    ...
    [2] = {
        ...
        [5] = "This place seems lively and fun.",
