...
{
	{31, 80, ""}, -- ²»ÖÐ½±
	{1, 1, "Rambutan", {2, 1, 30165, 1}},
	{1, 1, "Longan", {2, 1, 30164, 1}},
	{1, 1, "Cam", {2, 1, 30166, 1}},
	{1, 1, "Coconut", {2, 1, 30167, 1}},
	{1, 1, "Mangosteen", {2, 1, 30168, 1}},
	{1, 1, "Pomelo", {2, 1, 30169, 1}},
	{1, 1, "Strawberry", {2, 1, 30170, 1}},
	{1, 1, "Banana", {2, 1, 30171, 1}},
	{1, 1, "Mango", {2, 1, 30172, 1}},
	{1, 1, "Peach", {2, 1, 30173, 1}},
	{1, 1, "Plum", {2, 1, 30174, 1}},
	{1, 1, "Lychee", {2, 1, 30175, 1}},
	{1, 1, "Apple", {2, 1, 30176, 1}},
	{1, 1, "Avocado", {2, 1, 30177, 1}},
	{1, 1, "Papaya", {2, 1, 30178, 1}},
	{1, 1, "Soursop", {2, 1, 30179, 1}},
	{1, 1, "Pineapple", {2, 1, 30180, 1}},
	{1, 1, "Li", {2, 1, 30181, 1}},
	{1, 1, "Langsat", {2, 1, 30182, 1}},
	{1, 1, "Star Fruit", {2, 1, 30183, 1}}
}
...
function FG_Enter(mapID, zoneIndex)
	...
	if 1 <= zoneIndex and 8 >= zoneIndex then
		...
		Msg2Player("You have arrived"..FG_PLAYER_SPAWN_POINTS[zoneIndex][3].."Garden");
	else
