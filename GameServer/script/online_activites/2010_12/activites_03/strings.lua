...
--describe:Ô½ÄÏ°æ2010Äê9ÔÂ»î¶¯3 ×Ö·û´®ÎÄ¼þ
--=============================================
...
VET_201012_03_TB_STRING_LIST = {
    ...
    [7] = "§iÒu kiÖn kÝch ho¹t löa tr¹i lçi",
    [8] = "Mçi ng­êi cÇn mang theo 1 bã cñi míi cã thÓ kÝch ho¹t löa tr¹i",
    [9] = "Mçi ngµy mçi ng­êi ch¬i chØ ®­îc mua 1 bã cñi",
    [10] = "Nh©n vËt trªn cÊp 77, ®· gia nhËp m«n ph¸i vµ häc ®­îc kü n¨ng cÊp 55 míi cã thÓ kÝch ho¹t löa tr¹i.",
    [11] = "Mçi ngµy mçi nh©n vËt chØ ®­îc tham gia ho¹t ®éng %d lÇn.",
    [12] = "ChØ cã thÓ kÝch ho¹t löa tr¹i t¹i c¸c thµnh thÞ lín ( BiÖn Kinh, Thµnh §«, TuyÒn Ch©u, D­¬ng Ch©u, T­¬ng D­¬ng, §¹i Lý, Ph­îng T­êng)",
};
...
VET_201012_03_TB_NPCS = {
--    [1] = {"ÐÒÔËµÆÁý","Ó¥Éñ»ð¶Ñ",15,87719},    
      [1] = {"Löa tr¹i", "Löa tr¹i", 15, 87719},
};
