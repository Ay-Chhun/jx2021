...
Ms_stage6_shandow_index = 14		--»ÃÏóË÷Òý
Ms_stage6_real_box_seq = 15			--Ïä×ÓËæ»úÐòºÅ¼ÇÂ¼ID
...
--Ïä×ÓºÍÑ°±¦ÈËµÄ×ø±ê
 ...
 function stage6_boss_crt()
	...
	--ÅÐ¶ÏÊÇ·ñÊÇµÚÒ»´ÎË¢³öboss£¬Èç¹û²»ÊÇÔòÐèÐÞ¸ÄÑªÁ¿
 ...
 function stage6_shadow_crt()
	...
	NpcChat(boss_index,"¶o ¶nh mª hoÆc, c¸c ng­¬i cã thÓ ph¸ ¶nh trong t©m kh«ng? B·o c¸t ®ang kÐo ®Õn!")	
