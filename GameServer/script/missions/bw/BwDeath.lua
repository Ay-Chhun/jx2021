...
function OnDeath(Launcher)
	...
	if (PlayerIndex1 > 0) then
		...
		str = GetMissionS(CITYID).." - "..MapTab[GetMissionV(MS_ROOMINDEX)][3]..GetMissionS(1).." c飊g v韎  "..GetMissionS(2).."The one-on-one stage duel battle has ended,"..LaunName.." Trong thi u  nh b筰 "..DeathName..", winning the final victory!"
