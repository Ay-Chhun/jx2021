...
function shixian_shuoming()
	Say("Thêi h¹n L«i ®µi ®¬n trËn lµ 7 phót, sau ®ã cã 3 phót nghØ. Trong 3 phót, ®éi th¾ng trËn ph¶i chuÈn bÞ tiÕp tôc vµo khu vùc, ®éi míi khiªu chiÕn trong 3 phót ph¶i vµo khu vùc, nÕu kh«ng xem nh­ tõ bá quyÒn lîi. TÊt nhiªn sÏ cã hÖ thèng th«ng b¸o thêi gian vµo khu vùc.", 2, "trë l¹i/kan_shuoming", "Leave/no_say")
end

function shengfu_shuoming()
	Say("Quy t¾c duy nhÊt cña L«i ®µi lµ khi toµn bé thµnh viªn tiÒu ®éi bÞ ®¸nh b¹i, L«i ®µi buéc ph¶i kÕt thóc. NÕu trong thêi h¹n kh«ng ph©n th¾ng b¹i, thµnh viªn ®éi nµo cßn l¹i nhiÒu h¬n sÏ th¾ng trËn, sè thµnh viªn cßn l¹i cña hai ®éi t­¬ng ®­¬ng th× ®éi cã tæng ®iÓm kinh nghiÖm cao h¬n sÏ th¾ng, nÕu ®iÓn kinh nghiÖm còng t­¬ng ®­¬ng th× sÏ chän ngÉu nhiªn quyÕt ®Þnh ®éi nµo sÏ nhËn ®uîc t­ c¸ch C«ng thµnh.", 2, "trë l¹i/kan_shuoming", "Leave/no_say")
end
...
function canjia_leitai()
	...
	elseif nState == SIGNUP_TIME then
		...
		Say("B©y giê lµ thêi gian b¸o danh C«ng thµnh L«i ®µi, b¹n muèn tham gia?\rThêi gian b¸o danh cßn <color=yellow>"..nMin.." minutes"..nSec.." seconds<color>", 3, "Register/signup_yes", "KiÓm tra c¸c ®éi b¸o danh/view_sign_team", "Ta chØ ghÐ ngang qua th«i./no_say")
...
function ViewFightState()
	...
	szMsg = replace(szMsg, "|" ,"-")
	Say("G©y giê lµ thêi gian chuÈn bÞ cho c¸c ®éi tham gia C«ng thµnh L«i ®µi, mêi hai ®éi tham gia thi ®Êu tiÕn vµo L«i ®µi, ®éi kh«ng tham gia xin nhÊp vµo quan s¸t trËn ®Êu ®Ó vµo L«i ®µi. Thêi gian chuÈn bÞ cßn <color=green>"..nMin.." minutes"..nSec.."gi©y<color>\n<color=red>kh«ng cã ®éi bá trËn, qu¸ thêi gian chuÈn bÞ vÉn ch­a vµo thi ®Êu xem nh­ bá cuéc<color>\n"..szMsg, 
		2, 
...
function CanEnter()	
	...
	if nTeamSize + nJoinCount > 8 then
		Talk(1,"","The elite guild already has <color=yellow>"..nJoinCount.." <color> ®éi viªn trong L«i ®µi råi, sè thµnh viªn ®éi b¹n hiÖn lµ <color=yellow>"..nTeamSize.."ng­êi<color>, L«i ®µi C«ng thµnh chiÕn cho phÐp nhiÒu nhÊt <color=yellow>8 ng­êi<color> vµo.")
		return 0
	end
