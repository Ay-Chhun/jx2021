...
local nDecedentIndex = PlayerIndex;
	...
	if GetMissionV(GAME_TYPE) == 2 then
		Earn(10000);
		news_str = nMurderName.."  has killed"..nDecedentName..", nh薾 頲 1 ti襫 v祅g. Hi謓  nh b筰"..GetTaskTemp(TOTAL_KILL_NUM).." ngi.";
	else
		news_str = nMurderName.."  has killed"..nDecedentName..". Hi謓  nh b筰"..GetTaskTemp(TOTAL_KILL_NUM).." ngi.";
	end
