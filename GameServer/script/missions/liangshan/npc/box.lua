...
tClause4 = {
	...
	{{"Small Three Purity Ring"          	,{2,1,30308,1}},       5.00*100 ,7},
...
--	{{"ÅàÔªµ¤"         		,{2,1,30351,1}},   	2.50*100, 2},
	...
	{{"Brave Warrior Medal"       	,{2,1,30498,1}},    	4.80*100},
	{{"ThiÕt Tinh cÊp 1"       	,{2,1,30533,1}},    	9*100},
	{{"ThiÕt Tinh cÊp 2"       	,{2,1,30534,1}},    	0.70*100},
	{{"Cleansing Pill"       	,{2,1,30613,1}},    	5*100},
	{{"Thiªn Lı TruyÒn ¢m Phï ChØ"       	,{2,1,3508,1}},    	8*100},
	{{"Four Spirits Return to Origin Pill"       	,{2,1,30352,1}},    2.00*100},
	{{"Replenishing Origin Pill"         		,{2,1,30351,1}},		2.50*100},
}
