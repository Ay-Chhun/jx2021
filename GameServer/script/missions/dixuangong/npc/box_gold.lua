...
_t_ib_award_no_stage1 =
{
	...
	{
		--{"×ÏÏ¼ÃØ¼®",{0,107,65,1, 4}},
		{"Thiªn Kiªu LÖnh",{2, 97, 236,2},_stat_when_ib_consume},
	...
	t_ib_award =--ib½±Àø
	{
        ...
        { {"¸o Choµng Du HiÖp", {0,152,26,1}, nil,1, {1, 100}}, 30},
        { {"¸o Choµng ThiÕt HuyÕt", {0,152,27,1}, nil,1, {1, 100}}, 30},
        { {"¸o Choµng V©n Du", {0,152,28,1}, nil,1, {1, 100}}, 30},
        { {"Hoµng Kim §¹i Hång Bao (trèng)", {2,1,538,1}, 15}, 750},
    		{ {"B¹ch Kim §¹i Hång Bao (kh«ng)", {2,1,30228,1}, 15}, 100},
	},
}
