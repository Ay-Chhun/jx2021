...
function _get_3v3_last_season_award(nRank)
	...
	if nRank == 1 then
		...
		--
		gf_AddItemEx2({0,105,141,1,4,-1,-1,-1,-1,-1,-1}, "Flying Owl", "3V3", "PhÇn th­ëng quı tr­íc", 30 * 24 * 3600, 1)
		--
		--gf_AddItemEx2({2,1,30408,3,4}, "3¼¶Ç§»Ã¿Ì°å", "3V3", "ÉÏÈü¼¾½±Àø", 30 * 24 * 3600, 1)
		gf_AddItemEx2({2,1,30668,6,4}, "Spirit Essence Gathering Level 6", "3V3", "PhÇn th­ëng quı tr­íc", 30 * 24 * 3600, 1)
		--
		local tWaiZhuang = {
