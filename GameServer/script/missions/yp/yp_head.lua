...
--Èý¸öÊÆÁ¦µØÍ¼ID
tMainMapID = {{6000,"§¹i Lý Thiªn Long Tù"},{6100,"Tho Phon Quynh Ket"},{6200,"Tay Ha Hung Khanh"},{6300,"That Lac Nhai"},{6400,"Thiªn ¢m Th¸nh §Þa"}};
--ÕóÓª
...
--		qhys = {"Çàº£ÑÎÉÌ","Çàº£ÑÎÉÌ","\\script\\missions\\yp\\qhys_npc.lua",nil,CampOne,0},
	...
	[6100] = {
		...
		army2 = {"ChÊp Sù Hãa Sinh Tù 1", "Steward of Hoa Sinh Temple", "\\script\\missions\\yp\\army_npc.lua", 900, CampTwo, 0},
		army3 = {"ChÊp Sù Hãa Sinh Tù 2", "Steward of Hoa Sinh Temple", "\\script\\missions\\yp\\army_npc.lua", 900, CampTwo, 0},
...
--		qhys = {"Çàº£ÑÎÉÌ","Çàº£ÑÎÉÌ","\\script\\missions\\yp\\qhys_npc.lua",nil,CampTwo,0},
	...
	[6200] = {
		...
		army2 = {"T©y H¹ Chinh Nam Qu©n SÜ 1", "Tay Ha Southern Expedition Soldier", "\\script\\missions\\yp\\army_npc.lua", 900, CampThree, 0},
		army3 = {"T©y H¹ Chinh Nam Qu©n SÜ 2", "Tay Ha Southern Expedition Soldier", "\\script\\missions\\yp\\army_npc.lua", 900, CampThree, 0},
...
tBiaoChe = {
	{"Tiªu Xa 1","Standard Escort Cart"},
	{"Tiªu Xa 2","Important Escort Cart"},
	{"Tiªu Xa 3","Military Escort Cart"},
...
tSeedName = { --Ê÷ÖÖ
	...
	[3] = {{"Cherry Seed_Type 3",{2,95,900},{11,30},"tree_cherry3"},{"Peach Tree Seed_Type 3",{2,95,901},{11,30},"tree_peach3"},{"Hoa Tieu Seed_Type 3",{2,95,902},{11,30}, "tree_pepper3"},{"H¹t Gièng Thñy Sam_Lo¹i 3",{2,95,903},{11,30}, "tree_metasequoia3"}},
}
...
tRewardBox = {--Ä£°åÃû npcÃû ×´Ì¬Ãû³Æ Ð§¹ûÃèÊö Ä§·¨ÊôÐÔ×Ö·û´® ÊýÖµ ³ÖÐøÊ±¼ä
	{"Gi¸ vò khÝ_Ngoµi thµnh","Gi¸ vò khÝ",1787,3508,"Brave and Fierce","t¨ng lùc c«ng kÝch 100%, duy tr× 30 gi©y","state_p_attack_percent_add",100,30,"state_m_attack_percent_add",100,30},
	{"Gi¸ khiªn_Ngoµi thµnh","Gi¸ khiªn",1775,3411,"Ferocious","Increase defense power 100%, lasts 30 seconds","state_receive_half_damage",100,30},
	...
	{"Giµy giã_Ngoµi thµnh","Giµy giã",1851,3527,"Fake Step","Stealth, lasts 30 seconds","state_illusion_latent",0,30},
};
...
function yp_setValue(nType,Value)
	...
	local strMsg = {"Faction Contribution Level","PVP Points","Spirit Power Value","Kinh nghiÖm ®èi chiÕn ","Wulin Alliance Reputation"};
	if nType == 5 then
		--³ÌÐò½Ó¿Ú
	...
	elseif nType == 3 then
		...
		if nCurTask then
			...
			elseif Value < 0 then
				Msg2Player("You lose ["..strMsg[nType].."]"..abs(Value).." ®iÓm!");
			end
		end
	end
end
