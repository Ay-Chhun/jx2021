...
function dxy_talk_1(nType)
	...
	elseif nState == 1 then
		...
		Say(g_NpcName..tNpcName[nType][4], 2, 
			format("*Bá qua nhiÖm vô/#dxy_talk_1_1(%d)", nType), "End dialogue/nothing");
	else
