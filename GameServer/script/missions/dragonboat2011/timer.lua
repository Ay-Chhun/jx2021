...
function Process_Peace_Timer()
	...
	if nLoop <= 0 then
		...
		if mod(nLoop,3) == 0 then --5*3Ãë²¥·ÅÒ»´Î
			...
			Msg2MSAll(MISSIONID,"Tû lÖ sè ng­êi 2 phe:"..tCampName[1].."["..nPlayerOne.."]:["..nPlayerTwo.."]"..tCampName[2]..". When both sides reach"..PLAYER_NEED_NUM.." ng­êi, H¶i ChiÕn Long Ch©u sÏ b¾t ®Çu")
		end
