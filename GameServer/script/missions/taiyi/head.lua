...
MAX_TIMES_TO_ENTER_NORMAL = 16
MAX_TIMES_TO_ENTER_HERO = 8
...
tNpcs = {
	...
	xlsy = {"TYT_HXYsuiying","Asura Shattering Shadow", thisFile, CampEnemy},
	xlsy_1 = {"TYT_NXYsuiying","Asura Shattering Shadow", thisFile, CampEnemy},
	...
	ljfb = {"TYT_LJFB","Wild Fire Storm", thisFile, CampEnemy},
	ljfb_1 = {"TYT_LJFB","Wild Fire Storm", thisFile, CampEnemy},
...
TYT_PRICE = {
	[1] = {	--èóÌìÁÖ
		[1] = {		--Ãâ·Ñ·­ÅÆ
			[1] = {	--NORMAL
				{"Small Prajna Tree"			,{2,0,504,1,4},5000, 0, 7},
				{"Prajna Tree"				,{2,0,398,1,4},4000, 0, 7},
				{"Four Spirits Tree"					,{2,1,30269,1,4},5000, 0, 7},
				{"TruyÒn C«ng §¬n"					,{2,1,30313,1,4},5000, 0, 7},
				{"Xiu Zhen Yao Jue"				,{2,0,554,1,4},5000, 0, 7},
				{"Thiªn Lý TruyÒn ¢m Phï ChØ"		,{2,1,3508,1,4},3000},
				{"Four Spirits Return to Origin Pill"			,{2,1,30352,1,4},4000, 0, 7},
				{"Replenishing Origin Pill"					,{2,1,30351,1,4},4000, 0, 7},
		...
		[2] = {		--¸¶·Ñ·­ÅÆ
			[1] = {	--NORMAL
				{"Small Prajna Tree"			,{2,0,504,1},5000, 0, 7},
				{"Prajna Tree"				,{2,0,398,1},5000, 0, 7},
				{"Four Spirits Tree"					,{2,1,30269,1},5000, 0, 7},
				...
				{"Hero's Medal"				,{2,1,30499,1,4},20000},
				{"Hero's Medal"				,{2,1,30499,2,4},7000},
				{"Hero's Medal"				,{2,1,30499,4,4},800},
				{"Hero's Medal"				,{2,1,30499,10,4},200},
