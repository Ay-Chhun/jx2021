...
--		bt_level = 2
	...
	if (tbGAME_SIGNMAP[bt_level] ~= wid) then
		 ...
		 Say("N¨i nµy lµ"..szGAME_GAMELEVEL[maplevel]..", Æºng c p cÒa ng≠¨i chÿ c„ th” Æ’n"..szGAME_GAMELEVEL[bt_level].."register!", 0)--£ø£ø√ª”–∑÷µ»º∂µƒÃ· æ–≈œ¢		 
		 return
	end
...
if (BT_GetGameData(GAME_BATTLEID) ~= BT_GetData(PL_BATTLEID) or BT_GetGameData(GAME_BATTLESERIES) ~= BT_GetData(PL_BATTLESERIES)) then
	...
	if (bt_ncamp == 1) then
		Say(str, 2, "Join/bt_joinsong", "Ta suy ngh‹ lπi!/bt_oncancel");
	else
		Say(str, 2, "Join/bt_joinjin", "Ta suy ngh‹ lπi!/bt_oncancel");
	end
	return	
end;
...
Say( str, 2, "Alright!/bt_enterbattle", "ß” ta suy ngh‹ lπi/bt_oncancel");
end;
...
--	Msg2Player("’Ω“€π´∏Ê£∫–¬’Ω“€ø™ º¡À£¨ƒ˙…œ“ª¥Œµƒ’Ω“€◊‹’Ωπ¶Ω´±ª«Â¡„°£")
	...
	Say("Hoan ngh™nh anh hÔng trÎ thµnh t≠Ìng s‹ TËng Tri“u. Hi÷n Æ∑ khai chi’n! C„ muËn lÀp t¯c vµo chi’n tr≠Íng?", 2, "Alright!/bt_enterbattle", "ß” ta suy ngh‹ lπi/bt_oncancel");
end;
...
--	Msg2Player("’Ω“€π´∏Ê£∫–¬’Ω“€ø™ º¡À£¨ƒ˙…œ“ª¥Œµƒ’Ω“€◊‹’Ωπ¶Ω´±ª«Â¡„°£")
	...
	Say("Hoan ngh™nh anh hÔng trÎ thµnh dÚng s‹ Li™u QuËc. Hi÷n Æ∑ khai chi’n! C„ muËn lÀp t¯c vµo chi’n tr≠Íng?", 2, "Alright!/bt_enterbattle", "ß” ta suy ngh‹ lπi/bt_oncancel");
end;
