...
tInfo = {--¡¾NPC name¡¿={{taskid,},[{item info}],"item name",[sTalkMsg]} 
	...
	["Save the world"] = {{927},			nil,						"",					"Xem ra ng­¬i vÉn ch­a hiÓu râ gi¸o lý cña chóng ta, <color=red>®©y kh«ng ph¶i lµ gi¸o lý cña §¹o Gia<color>.",},
	...
	["Empty the mind, keep stillness"] = {{927},			{2,96,127,1,4},	"Empty the mind, keep stillness",	"V¹n vËt tÞnh t¸c, ng« dÜ quan phôc. Phu vËt v©n v©n, c¸c phôc quy tÒ c¨n. Quy c¨n viÕt tÜnh, thÞ viÕt phôc mÖnh. Phôc mÖnh viÕt th­êng, tri th­êng viÕt minh. <color=yellow>Ng­¬i chän ®óng råi, ®©y chÝnh lµ gi¸o lý cña §¹o Gia<color>.",},
	["Nirvana and rebirth"] = {{927},			nil,						"",					"Xem ra ng­¬i vÉn ch­a hiÓu râ gi¸o lý cña chóng ta, <color=red>®©y kh«ng ph¶i lµ gi¸o lý cña §¹o Gia<color>.",},
	}
function main()
