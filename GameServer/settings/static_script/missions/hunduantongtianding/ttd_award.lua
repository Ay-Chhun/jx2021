...
_t_free_award_no_stage =
{
	...
	t_other_group = --ÔÓÎï×é
	{
        ...
        { {"Cultivation Truth Fragment", {2,1,30315,1}, nil,nil,{1, 100} }, 400},
        { {"TiÓu B¹ch C©u hoµn", {2,1,30307,1}, nil,nil,{1, 100} }, 400},
        { {"Small Three Purity Ring", {2,1,30308,1}, nil,nil,{1, 100} }, 400},
        { {"TiÓu Lôc ThÇn Hoµn", {2,1,30309,1}, nil,nil,{1, 100} }, 300},
        { {"TruyÒn C«ng §¬n", {2,1,30313,1}, nil,nil,{1, 100} }, 400},
        { {"Replenishing Origin Pill", {2,1,30351,1}, nil,nil,{1, 100} }, 400},
	},
};
...
_t_ib_award_no_stage =
{
	...
	t_ib_award =--ib½±Àø
	{
		...
		{{"Life-Begetting Powder",{1,0,16,1},nil,nil,{1, 100} },300},
		{{"Money Pouch",{2,1,30367,1},nil,nil,{1, 100} },600},
		{{"Cöu chuyÓn håi hån ®¬n",{1,0,32,1},nil,nil,{1, 100} },200},
		{{"Small Prajna Tree",{2,0,504,1},30,nil,{1, 100} },100},
		{{"M¶nh Thiªn th¹ch",{2,2,7,1},nil,nil,{1, 100} },300},
		{{"Money Pouch",{2,1,30367,2},nil,nil,{1, 100} },500},
		{{"Xiu Zhen Yao Jue",{2,0,554,1},30,nil,{1, 100} },200},
		...
		{{"Money Pouch",{2,1,30367,8},nil,nil,{1, 100} },400},
		...
		{{"Seed bag",{2,1,30087,1},30,nil,{1, 100} },100},
		{{"Money Pouch",{2,1,30367,16},nil,nil,{1, 100} },300},
		{{"M¶nh Thiªn M«n",{2,1,30410,5},nil,nil,{1, 100} },200},
		{{"S­ m«n lÖnh kú",{2,1,1017,1},30,nil,{1, 100} },100},
		{{"Money Pouch",{2,1,30367,32},nil,nil,{1, 100} },100},
		{{"Four Spirits Return to Origin Pill",{2,1,30352,1},30,nil,{1, 100} },100},
		...
		{{"Money Pouch",{2,1,30367,40},nil,nil,{1, 100} },100},
