...
--        { {"¹ÅÁéÊ¯", {2,1,30368,40}, nil,nil, {1, 100}}, 100},
	...
	t_other_group = --ÔÓÎï×é
	{
        ...
        { {"Coarse Cloth Shoes", {0,154,1,1}, nil,nil, {1, 100}}, 600},
        { {"Refined Cloth Shoes", {0,154,2,1}, nil,nil, {1, 100}}, 600},
        { {"Gao Tong Wa Recipe", {0,154,3,1}, nil,nil, {1, 100}}, 600},
        ...
        { {"Iron Blood Boots", {0,154,27,1}, nil,1, {1, 100}}, 1},
...
_t_ib_award_no_stage =
{
	...
	t_ib_award =--ib½±Àø
	{
        ...
        { {"Hero's Medal", {2,1,30499,1,4}, nil,nil, {1, 100}}, 1506},
        { {"Hero's Medal", {2,1,30499,2,4}, nil,nil, {1, 100}}, 500},
        { {"Hero's Medal", {2,1,30499,4,4}, nil,nil, {1, 100}}, 100},
        { {"Hero's Medal", {2,1,30499,10,4}, nil,nil, {1, 100}}, 123},
        ...
        { {"Coarse Cloth Shoes", {0,154,1,1}, nil,nil, {1, 100}}, 400},
        { {"Refined Cloth Shoes", {0,154,2,1}, nil,nil, {1, 100}}, 400},
        { {"Gao Tong Wa Recipe", {0,154,3,1}, nil,nil, {1, 100}}, 306},
        ...
        { {"Iron Blood Boots", {0,154,27,1}, nil,1, {1, 100}}, 30},
